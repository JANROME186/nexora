...
current_phase: HOP-HARD-BE-001 closed. Final hardening continues with IAM/session/entitlement runtime controls.
commercial_product_progress:
  status: active
  current_iteration: HOP-HARD-IAM-001
...
implementation_progress:
  current_backlog_item: HOP-HARD-IAM-001
  active_backlog_item: HOP-HARD-IAM-001
