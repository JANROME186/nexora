...
const STORAGE_KEY = "hop.public-website.locale";
...
/**
 * Provides the active locale, a setter that persists the visitor's choice, and the resolved
 * message catalog for that locale. Defaults to es-MX; falls back to en-US if a stored value is
 * invalid. Anonymous visitors are never asked to authenticate, so this is the only per-visitor
 * state the public website keeps.
 */
