...
export const enUS: MessageCatalog = {
  ...
  mobileGreeting: "Welcome, {displayName}",
  mobileTenantScope: "Tenant scope: {tenantId}",
  mobileRouteLabels: {
    ...
    "patient-results": "My results",
    "patient-notifications": "My notifications",
  },
  patientMobileTitle: "Patient mobile portal",
  patientMobileEmpty: "No information is available for your profile.",
  patientMobileForbidden: "Your session is not allowed to access the patient mobile portal.",
};
