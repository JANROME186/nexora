# BCM-LAB-002 — Sample Collection Requirements

**Spanish:** Toma de Muestras
...
The platform shall support traceable execution of toma de muestras from diagnostic order to result lifecycle.
...
The platform shall enforce sample, test, branch and user authorization rules before allowing toma de muestras.
...
The platform shall record timestamps, responsible users, exceptions and status transitions for toma de muestras.
...
### US-LAB-002-001 — Manage Sample Collection

As an authorized user, I want to manage Sample Collection so that the organization can operate this capability consistently.
...
### US-LAB-002-002 — Search Sample Collection

As an authorized user, I want to search and filter Sample Collection so that I can find records quickly.
...
### US-LAB-002-003 — Audit Sample Collection

As a supervisor, I want to review the audit history of Sample Collection so that I can verify accountability and compliance.
...
### US-LAB-002-004 — Configure Sample Collection

As an administrator, I want to configure Sample Collection according to laboratory and branch rules so that the workflow fits operational needs.
...
### US-LAB-002-005 — Report Sample Collection

As a manager, I want to view indicators for Sample Collection so that I can make operational decisions.
...
artifact:
  ...
  name: Sample Collection Requirements
  version: 1.0.0
  status: approved
  owner: Product Requirements Team
  source_of_truth: 04-requirements/capabilities/bcm-lab-002-sample-collection/requirements.md
  depends_on:
  - BCM-LAB-002
  - BCM-001
capability:
...
- id: US-LAB-002-001
  capability: BCM-LAB-002
  title: Manage Sample Collection
  story: As an authorized user, I want to manage Sample Collection so that the organization
...
- id: US-LAB-002-002
  capability: BCM-LAB-002
  title: Search Sample Collection
  story: As an authorized user, I want to search and filter Sample Collection so that
...
- id: US-LAB-002-003
  capability: BCM-LAB-002
  title: Audit Sample Collection
  story: As a supervisor, I want to review the audit history of Sample Collection
...
- id: US-LAB-002-004
  capability: BCM-LAB-002
  title: Configure Sample Collection
  story: As an administrator, I want to configure Sample Collection according to laboratory
...
- id: US-LAB-002-005
  capability: BCM-LAB-002
  title: Report Sample Collection
  story: As a manager, I want to view indicators for Sample Collection so that I can
