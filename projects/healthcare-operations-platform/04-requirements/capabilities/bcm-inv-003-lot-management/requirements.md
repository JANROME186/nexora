# BCM-INV-003 — Lot Management Requirements
...
The platform shall manage lotes with branch-level stock control, lot traceability and expiration handling.
...
The platform shall record stock movements, responsible users and business justification for lotes.
...
The platform shall relate Lot Management to diagnostic services and quality workflows when applicable.
...
### US-INV-003-001 — Manage Lot Management

As an authorized user, I want to manage Lot Management so that the organization can operate this capability consistently.
...
### US-INV-003-002 — Search Lot Management

As an authorized user, I want to search and filter Lot Management so that I can find records quickly.
...
### US-INV-003-003 — Audit Lot Management

As a supervisor, I want to review the audit history of Lot Management so that I can verify accountability and compliance.
...
### US-INV-003-004 — Configure Lot Management

As an administrator, I want to configure Lot Management according to laboratory and branch rules so that the workflow fits operational needs.
...
### US-INV-003-005 — Report Lot Management

As a manager, I want to view indicators for Lot Management so that I can make operational decisions.
...
artifact:
  ...
  name: Lot Management Requirements
  version: 1.0.0
  status: approved
  owner: Product Requirements Team
  source_of_truth: 04-requirements/capabilities/bcm-inv-003-lot-management/requirements.md
  depends_on:
  - BCM-INV-003
  - BCM-001
capability:
...
- id: US-INV-003-001
  capability: BCM-INV-003
  title: Manage Lot Management
  story: As an authorized user, I want to manage Lot Management so that the organization
...
- id: US-INV-003-002
  capability: BCM-INV-003
  title: Search Lot Management
  story: As an authorized user, I want to search and filter Lot Management so that
...
- id: US-INV-003-003
  capability: BCM-INV-003
  title: Audit Lot Management
  story: As a supervisor, I want to review the audit history of Lot Management so
...
- id: US-INV-003-004
  capability: BCM-INV-003
  title: Configure Lot Management
  story: As an administrator, I want to configure Lot Management according to laboratory
...
- id: US-INV-003-005
  capability: BCM-INV-003
  title: Report Lot Management
  story: As a manager, I want to view indicators for Lot Management so that I can
