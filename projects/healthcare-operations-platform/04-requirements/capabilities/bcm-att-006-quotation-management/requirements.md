# BCM-ATT-006 — Quotation Management Requirements
...
The platform shall support end-to-end execution of cotizaciones at branch level.
...
The platform shall validate patient, branch, service, user and payment prerequisites before completing cotizaciones.
...
The platform shall record operational and financial audit events for cotizaciones.
...
The platform shall provide user-friendly web workflows for cotizaciones optimized for reception and cashier operations.
...
The platform shall expose Quotation Management status changes to downstream clinical, billing, notification and reporting workflows.
...
### US-ATT-006-001 — Manage Quotation Management

As an authorized user, I want to manage Quotation Management so that the organization can operate this capability consistently.
...
### US-ATT-006-002 — Search Quotation Management

As an authorized user, I want to search and filter Quotation Management so that I can find records quickly.
...
### US-ATT-006-003 — Audit Quotation Management

As a supervisor, I want to review the audit history of Quotation Management so that I can verify accountability and compliance.
...
### US-ATT-006-004 — Configure Quotation Management

As an administrator, I want to configure Quotation Management according to laboratory and branch rules so that the workflow fits operational needs.
...
### US-ATT-006-005 — Report Quotation Management

As a manager, I want to view indicators for Quotation Management so that I can make operational decisions.
...
artifact:
  ...
  name: Quotation Management Requirements
  version: 1.0.0
  status: approved
  owner: Product Requirements Team
  source_of_truth: 04-requirements/capabilities/bcm-att-006-quotation-management/requirements.md
  depends_on:
  - BCM-ATT-006
  - BCM-001
capability:
  ...
  id: BCM-ATT-006
  name_en: Quotation Management
  name_es: Cotizaciones
  priority: High
  roadmap: MVP1
actors:
- Receptionist
...
- id: US-ATT-006-001
  capability: BCM-ATT-006
  title: Manage Quotation Management
  story: As an authorized user, I want to manage Quotation Management so that the
...
- id: US-ATT-006-002
  capability: BCM-ATT-006
  title: Search Quotation Management
  story: As an authorized user, I want to search and filter Quotation Management so
...
- id: US-ATT-006-003
  capability: BCM-ATT-006
  title: Audit Quotation Management
  story: As a supervisor, I want to review the audit history of Quotation Management
...
- id: US-ATT-006-004
  capability: BCM-ATT-006
  title: Configure Quotation Management
  story: As an administrator, I want to configure Quotation Management according to
...
- id: US-ATT-006-005
  capability: BCM-ATT-006
  title: Report Quotation Management
  story: As a manager, I want to view indicators for Quotation Management so that
