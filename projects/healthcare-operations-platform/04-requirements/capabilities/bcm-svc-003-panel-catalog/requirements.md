# BCM-SVC-003 — Panel Catalog Requirements

**Spanish:** Catálogo de Paneles
...
The platform shall allow authorized users to configure and version catálogo de paneles.
...
The platform shall prevent clinical use of incomplete, inactive or deprecated catálogo de paneles.
...
The platform shall support effective dates, branch availability and pricing relationships for catálogo de paneles.
...
The platform shall track changes to catálogo de paneles and preserve the version used by each diagnostic order.
...
The platform shall expose Panel Catalog configuration through APIs used by ordering, results, billing and inventory.
...
### US-SVC-003-001 — Manage Panel Catalog

As an authorized user, I want to manage Panel Catalog so that the organization can operate this capability consistently.
...
### US-SVC-003-002 — Search Panel Catalog

As an authorized user, I want to search and filter Panel Catalog so that I can find records quickly.
...
### US-SVC-003-003 — Audit Panel Catalog

As a supervisor, I want to review the audit history of Panel Catalog so that I can verify accountability and compliance.
...
### US-SVC-003-004 — Configure Panel Catalog

As an administrator, I want to configure Panel Catalog according to laboratory and branch rules so that the workflow fits operational needs.
...
### US-SVC-003-005 — Report Panel Catalog

As a manager, I want to view indicators for Panel Catalog so that I can make operational decisions.
...
artifact:
  ...
  name: Panel Catalog Requirements
  version: 1.0.0
  status: approved
  owner: Product Requirements Team
  source_of_truth: 04-requirements/capabilities/bcm-svc-003-panel-catalog/requirements.md
  depends_on:
  - BCM-SVC-003
  - BCM-001
capability:
  ...
  id: BCM-SVC-003
  name_en: Panel Catalog
  name_es: Catálogo de Paneles
  priority: High
  roadmap: MVP1
actors:
- Laboratory Administrator
...
- id: US-SVC-003-001
  capability: BCM-SVC-003
  title: Manage Panel Catalog
  story: As an authorized user, I want to manage Panel Catalog so that the organization
...
- id: US-SVC-003-002
  capability: BCM-SVC-003
  title: Search Panel Catalog
  story: As an authorized user, I want to search and filter Panel Catalog so that
...
- id: US-SVC-003-003
  capability: BCM-SVC-003
  title: Audit Panel Catalog
  story: As a supervisor, I want to review the audit history of Panel Catalog so that
...
- id: US-SVC-003-004
  capability: BCM-SVC-003
  title: Configure Panel Catalog
  story: As an administrator, I want to configure Panel Catalog according to laboratory
...
- id: US-SVC-003-005
  capability: BCM-SVC-003
  title: Report Panel Catalog
  story: As a manager, I want to view indicators for Panel Catalog so that I can make
