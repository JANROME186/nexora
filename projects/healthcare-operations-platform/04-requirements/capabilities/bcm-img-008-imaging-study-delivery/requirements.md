# BCM-IMG-008 — Imaging Study Delivery Requirements

**Spanish:** Entrega de Estudios
...
The platform shall support operational management of entrega de estudios for imaging centers and branches.
...
The platform shall integrate Imaging Study Delivery workflows with orders, results, patient portal and doctor portal.
...
### US-IMG-008-001 — Manage Imaging Study Delivery

As an authorized user, I want to manage Imaging Study Delivery so that the organization can operate this capability consistently.
...
### US-IMG-008-002 — Search Imaging Study Delivery

As an authorized user, I want to search and filter Imaging Study Delivery so that I can find records quickly.
...
### US-IMG-008-003 — Audit Imaging Study Delivery

As a supervisor, I want to review the audit history of Imaging Study Delivery so that I can verify accountability and compliance.
...
### US-IMG-008-004 — Configure Imaging Study Delivery

As an administrator, I want to configure Imaging Study Delivery according to laboratory and branch rules so that the workflow fits operational needs.
...
### US-IMG-008-005 — Report Imaging Study Delivery

As a manager, I want to view indicators for Imaging Study Delivery so that I can make operational decisions.
...
artifact:
  ...
  name: Imaging Study Delivery Requirements
  version: 1.0.0
  status: approved
  owner: Product Requirements Team
  source_of_truth: 04-requirements/capabilities/bcm-img-008-imaging-study-delivery/requirements.md
  depends_on:
  - BCM-IMG-008
  - BCM-001
capability:
  ...
  domain_name: Imaging
  id: BCM-IMG-008
  name_en: Imaging Study Delivery
  name_es: Entrega de Estudios
  priority: High
  roadmap: MVP3
actors:
- Radiology Technician
...
- id: US-IMG-008-001
  capability: BCM-IMG-008
  title: Manage Imaging Study Delivery
  story: As an authorized user, I want to manage Imaging Study Delivery so that the
...
- id: US-IMG-008-002
  capability: BCM-IMG-008
  title: Search Imaging Study Delivery
  story: As an authorized user, I want to search and filter Imaging Study Delivery
...
- id: US-IMG-008-003
  capability: BCM-IMG-008
  title: Audit Imaging Study Delivery
  story: As a supervisor, I want to review the audit history of Imaging Study Delivery
...
- id: US-IMG-008-004
  capability: BCM-IMG-008
  title: Configure Imaging Study Delivery
  story: As an administrator, I want to configure Imaging Study Delivery according
...
- id: US-IMG-008-005
  capability: BCM-IMG-008
  title: Report Imaging Study Delivery
  story: As a manager, I want to view indicators for Imaging Study Delivery so that
