# BCM-SVC-001 — Diagnostic Service Catalog Requirements

**Spanish:** Catálogo de Servicios
...
The platform shall allow authorized users to configure and version catálogo de servicios.
...
The platform shall prevent clinical use of incomplete, inactive or deprecated catálogo de servicios.
...
The platform shall support effective dates, branch availability and pricing relationships for catálogo de servicios.
...
The platform shall track changes to catálogo de servicios and preserve the version used by each diagnostic order.
...
The platform shall expose Diagnostic Service Catalog configuration through APIs used by ordering, results, billing and inventory.
...
### US-SVC-001-001 — Manage Diagnostic Service Catalog

As an authorized user, I want to manage Diagnostic Service Catalog so that the organization can operate this capability consistently.
...
### US-SVC-001-002 — Search Diagnostic Service Catalog

As an authorized user, I want to search and filter Diagnostic Service Catalog so that I can find records quickly.
...
### US-SVC-001-003 — Audit Diagnostic Service Catalog

As a supervisor, I want to review the audit history of Diagnostic Service Catalog so that I can verify accountability and compliance.
...
### US-SVC-001-004 — Configure Diagnostic Service Catalog

As an administrator, I want to configure Diagnostic Service Catalog according to laboratory and branch rules so that the workflow fits operational needs.
...
### US-SVC-001-005 — Report Diagnostic Service Catalog

As a manager, I want to view indicators for Diagnostic Service Catalog so that I can make operational decisions.
...
artifact:
  ...
  name: Diagnostic Service Catalog Requirements
  version: 1.0.0
  status: approved
  owner: Product Requirements Team
  source_of_truth: 04-requirements/capabilities/bcm-svc-001-diagnostic-service-catalog/requirements.md
  depends_on:
  - BCM-SVC-001
  - BCM-001
capability:
  ...
  id: BCM-SVC-001
  name_en: Diagnostic Service Catalog
  name_es: Catálogo de Servicios
  priority: Critical
  roadmap: MVP1
actors:
- Laboratory Administrator
...
- id: US-SVC-001-001
  capability: BCM-SVC-001
  title: Manage Diagnostic Service Catalog
  story: As an authorized user, I want to manage Diagnostic Service Catalog so that
...
- id: US-SVC-001-002
  capability: BCM-SVC-001
  title: Search Diagnostic Service Catalog
  story: As an authorized user, I want to search and filter Diagnostic Service Catalog
...
- id: US-SVC-001-003
  capability: BCM-SVC-001
  title: Audit Diagnostic Service Catalog
  story: As a supervisor, I want to review the audit history of Diagnostic Service
    Catalog so that I can verify accountability and compliance.
  priority: Critical
  roadmap: MVP1
  acceptance_criteria:
  - 'Scenario: authorized access is allowed and unauthorized access is denied.'
...
- id: US-SVC-001-004
  capability: BCM-SVC-001
  title: Configure Diagnostic Service Catalog
  story: As an administrator, I want to configure Diagnostic Service Catalog according
...
- id: US-SVC-001-005
  capability: BCM-SVC-001
  title: Report Diagnostic Service Catalog
  story: As a manager, I want to view indicators for Diagnostic Service Catalog so
