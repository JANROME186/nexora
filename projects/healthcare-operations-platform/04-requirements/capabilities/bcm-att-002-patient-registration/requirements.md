# BCM-ATT-002 — Patient Registration Requirements

**Spanish:** Registro de Pacientes
...
The platform shall support end-to-end execution of registro de pacientes at branch level.
...
The platform shall validate patient, branch, service, user and payment prerequisites before completing registro de pacientes.
...
The platform shall record operational and financial audit events for registro de pacientes.
...
The platform shall provide user-friendly web workflows for registro de pacientes optimized for reception and cashier operations.
...
The platform shall expose Patient Registration status changes to downstream clinical, billing, notification and reporting workflows.
...
### US-ATT-002-001 — Manage Patient Registration

As an authorized user, I want to manage Patient Registration so that the organization can operate this capability consistently.
...
### US-ATT-002-002 — Search Patient Registration

As an authorized user, I want to search and filter Patient Registration so that I can find records quickly.
...
### US-ATT-002-003 — Audit Patient Registration

As a supervisor, I want to review the audit history of Patient Registration so that I can verify accountability and compliance.
...
### US-ATT-002-004 — Configure Patient Registration

As an administrator, I want to configure Patient Registration according to laboratory and branch rules so that the workflow fits operational needs.
...
### US-ATT-002-005 — Report Patient Registration

As a manager, I want to view indicators for Patient Registration so that I can make operational decisions.
...
artifact:
  ...
  name: Patient Registration Requirements
  version: 1.0.0
  status: approved
  owner: Product Requirements Team
  source_of_truth: 04-requirements/capabilities/bcm-att-002-patient-registration/requirements.md
  depends_on:
  - BCM-ATT-002
  - BCM-001
capability:
  ...
  id: BCM-ATT-002
  name_en: Patient Registration
  name_es: Registro de Pacientes
  priority: Critical
  roadmap: MVP1
actors:
- Receptionist
...
- id: US-ATT-002-001
  capability: BCM-ATT-002
  title: Manage Patient Registration
  story: As an authorized user, I want to manage Patient Registration so that the
...
- id: US-ATT-002-002
  capability: BCM-ATT-002
  title: Search Patient Registration
  story: As an authorized user, I want to search and filter Patient Registration so
...
- id: US-ATT-002-003
  capability: BCM-ATT-002
  title: Audit Patient Registration
  story: As a supervisor, I want to review the audit history of Patient Registration
...
- id: US-ATT-002-004
  capability: BCM-ATT-002
  title: Configure Patient Registration
  story: As an administrator, I want to configure Patient Registration according to
...
- id: US-ATT-002-005
  capability: BCM-ATT-002
  title: Report Patient Registration
  story: As a manager, I want to view indicators for Patient Registration so that
