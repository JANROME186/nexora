# BCM-LAB-001 — Diagnostic Order Management Requirements

**Spanish:** Gestión de Órdenes
...
The platform shall support traceable execution of gestión de órdenes from diagnostic order to result lifecycle.
...
The platform shall enforce sample, test, branch and user authorization rules before allowing gestión de órdenes.
...
The platform shall record timestamps, responsible users, exceptions and status transitions for gestión de órdenes.
...
### US-LAB-001-001 — Manage Diagnostic Order Management

As an authorized user, I want to manage Diagnostic Order Management so that the organization can operate this capability consistently.
...
### US-LAB-001-002 — Search Diagnostic Order Management

As an authorized user, I want to search and filter Diagnostic Order Management so that I can find records quickly.
...
### US-LAB-001-003 — Audit Diagnostic Order Management

As a supervisor, I want to review the audit history of Diagnostic Order Management so that I can verify accountability and compliance.
...
### US-LAB-001-004 — Configure Diagnostic Order Management

As an administrator, I want to configure Diagnostic Order Management according to laboratory and branch rules so that the workflow fits operational needs.
...
### US-LAB-001-005 — Report Diagnostic Order Management

As a manager, I want to view indicators for Diagnostic Order Management so that I can make operational decisions.
...
artifact:
  ...
  name: Diagnostic Order Management Requirements
  version: 1.0.0
  status: approved
  owner: Product Requirements Team
  source_of_truth: 04-requirements/capabilities/bcm-lab-001-diagnostic-order-management/requirements.md
  depends_on:
  - BCM-LAB-001
  - BCM-001
capability:
  ...
  id: BCM-LAB-001
  name_en: Diagnostic Order Management
  name_es: Gestión de Órdenes
  priority: Critical
  roadmap: MVP1
actors:
- Sample Collector
...
- id: US-LAB-001-001
  capability: BCM-LAB-001
  title: Manage Diagnostic Order Management
  story: As an authorized user, I want to manage Diagnostic Order Management so that
...
- id: US-LAB-001-002
  capability: BCM-LAB-001
  title: Search Diagnostic Order Management
  story: As an authorized user, I want to search and filter Diagnostic Order Management
...
- id: US-LAB-001-003
  capability: BCM-LAB-001
  title: Audit Diagnostic Order Management
  story: As a supervisor, I want to review the audit history of Diagnostic Order Management
...
- id: US-LAB-001-004
  capability: BCM-LAB-001
  title: Configure Diagnostic Order Management
  story: As an administrator, I want to configure Diagnostic Order Management according
...
- id: US-LAB-001-005
  capability: BCM-LAB-001
  title: Report Diagnostic Order Management
  story: As a manager, I want to view indicators for Diagnostic Order Management so
