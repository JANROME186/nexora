# BCM-PER-006 — Supplier Management Requirements

**Spanish:** Gestión de Proveedores
...
The platform shall manage master data for gestión de proveedores, avoiding duplicate person records across roles.
...
The platform shall support search, registration, update, deactivation and audit of gestión de proveedores.
...
The platform shall allow authorized users to link gestión de proveedores to clinical, administrative and portal workflows.
...
The platform shall expose privacy-safe views of gestión de proveedores according to user role, consent and authorization.
...
### US-PER-006-001 — Manage Supplier Management

As an authorized user, I want to manage Supplier Management so that the organization can operate this capability consistently.
...
### US-PER-006-002 — Search Supplier Management

As an authorized user, I want to search and filter Supplier Management so that I can find records quickly.
...
### US-PER-006-003 — Audit Supplier Management

As a supervisor, I want to review the audit history of Supplier Management so that I can verify accountability and compliance.
...
### US-PER-006-004 — Configure Supplier Management

As an administrator, I want to configure Supplier Management according to laboratory and branch rules so that the workflow fits operational needs.
...
### US-PER-006-005 — Report Supplier Management

As a manager, I want to view indicators for Supplier Management so that I can make operational decisions.
...
artifact:
  ...
  name: Supplier Management Requirements
  version: 1.0.0
  status: approved
  owner: Product Requirements Team
  source_of_truth: 04-requirements/capabilities/bcm-per-006-supplier-management/requirements.md
  depends_on:
  - BCM-PER-006
  - BCM-001
capability:
  ...
  name_es: Gestión de Proveedores
  priority: High
  roadmap: MVP2
actors:
- Receptionist
...
- id: US-PER-006-001
  capability: BCM-PER-006
  title: Manage Supplier Management
  story: As an authorized user, I want to manage Supplier Management so that the organization
...
- id: US-PER-006-002
  capability: BCM-PER-006
  title: Search Supplier Management
  story: As an authorized user, I want to search and filter Supplier Management so
...
- id: US-PER-006-003
  capability: BCM-PER-006
  title: Audit Supplier Management
  story: As a supervisor, I want to review the audit history of Supplier Management
...
- id: US-PER-006-004
  capability: BCM-PER-006
  title: Configure Supplier Management
  story: As an administrator, I want to configure Supplier Management according to
...
- id: US-PER-006-005
  capability: BCM-PER-006
  title: Report Supplier Management
  story: As a manager, I want to view indicators for Supplier Management so that I
