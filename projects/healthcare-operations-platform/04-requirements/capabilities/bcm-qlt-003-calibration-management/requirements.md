# BCM-QLT-003 — Calibration Management Requirements

**Spanish:** Calibraciones
...
The platform shall support documented execution and traceability of calibraciones.
...
The platform shall allow authorized users to record observations, evidence, corrective actions and approvals for calibraciones.
...
The platform shall link calibraciones to equipment, tests, branches, users and affected results where applicable.
...
The platform shall generate audit-ready evidence and reports for calibraciones.
...
### US-QLT-003-001 — Manage Calibration Management

As an authorized user, I want to manage Calibration Management so that the organization can operate this capability consistently.
...
### US-QLT-003-002 — Search Calibration Management

As an authorized user, I want to search and filter Calibration Management so that I can find records quickly.
...
### US-QLT-003-003 — Audit Calibration Management

As a supervisor, I want to review the audit history of Calibration Management so that I can verify accountability and compliance.
...
### US-QLT-003-004 — Configure Calibration Management

As an administrator, I want to configure Calibration Management according to laboratory and branch rules so that the workflow fits operational needs.
...
### US-QLT-003-005 — Report Calibration Management

As a manager, I want to view indicators for Calibration Management so that I can make operational decisions.
...
artifact:
  ...
  name: Calibration Management Requirements
  version: 1.0.0
  status: approved
  owner: Product Requirements Team
  source_of_truth: 04-requirements/capabilities/bcm-qlt-003-calibration-management/requirements.md
  depends_on:
  - BCM-QLT-003
  - BCM-001
capability:
  ...
  domain_name: Quality
  id: BCM-QLT-003
  name_en: Calibration Management
  name_es: Calibraciones
  priority: High
  roadmap: MVP2
actors:
- Quality Manager
...
- id: US-QLT-003-001
  capability: BCM-QLT-003
  title: Manage Calibration Management
  story: As an authorized user, I want to manage Calibration Management so that the
...
- id: US-QLT-003-002
  capability: BCM-QLT-003
  title: Search Calibration Management
  story: As an authorized user, I want to search and filter Calibration Management
...
- id: US-QLT-003-003
  capability: BCM-QLT-003
  title: Audit Calibration Management
  story: As a supervisor, I want to review the audit history of Calibration Management
...
- id: US-QLT-003-004
  capability: BCM-QLT-003
  title: Configure Calibration Management
  story: As an administrator, I want to configure Calibration Management according
...
- id: US-QLT-003-005
  capability: BCM-QLT-003
  title: Report Calibration Management
  story: As a manager, I want to view indicators for Calibration Management so that
