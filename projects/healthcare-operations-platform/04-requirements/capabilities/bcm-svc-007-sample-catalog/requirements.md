# BCM-SVC-007 — Sample Catalog Requirements

**Spanish:** Catálogo de Muestras
...
The platform shall allow authorized users to configure and version catálogo de muestras.
...
The platform shall prevent clinical use of incomplete, inactive or deprecated catálogo de muestras.
...
The platform shall support effective dates, branch availability and pricing relationships for catálogo de muestras.
...
The platform shall track changes to catálogo de muestras and preserve the version used by each diagnostic order.
...
The platform shall expose Sample Catalog configuration through APIs used by ordering, results, billing and inventory.
...
### US-SVC-007-001 — Manage Sample Catalog

As an authorized user, I want to manage Sample Catalog so that the organization can operate this capability consistently.
...
### US-SVC-007-002 — Search Sample Catalog

As an authorized user, I want to search and filter Sample Catalog so that I can find records quickly.
...
### US-SVC-007-003 — Audit Sample Catalog

As a supervisor, I want to review the audit history of Sample Catalog so that I can verify accountability and compliance.
...
### US-SVC-007-004 — Configure Sample Catalog

As an administrator, I want to configure Sample Catalog according to laboratory and branch rules so that the workflow fits operational needs.
...
### US-SVC-007-005 — Report Sample Catalog

As a manager, I want to view indicators for Sample Catalog so that I can make operational decisions.
...
artifact:
  ...
  name: Sample Catalog Requirements
  version: 1.0.0
  status: approved
  owner: Product Requirements Team
  source_of_truth: 04-requirements/capabilities/bcm-svc-007-sample-catalog/requirements.md
  depends_on:
  - BCM-SVC-007
  - BCM-001
capability:
  ...
  id: BCM-SVC-007
  name_en: Sample Catalog
  name_es: Catálogo de Muestras
  priority: High
  roadmap: MVP1
actors:
- Laboratory Administrator
...
- id: US-SVC-007-001
  capability: BCM-SVC-007
  title: Manage Sample Catalog
  story: As an authorized user, I want to manage Sample Catalog so that the organization
...
- id: US-SVC-007-002
  capability: BCM-SVC-007
  title: Search Sample Catalog
  story: As an authorized user, I want to search and filter Sample Catalog so that
...
- id: US-SVC-007-003
  capability: BCM-SVC-007
  title: Audit Sample Catalog
  story: As a supervisor, I want to review the audit history of Sample Catalog so
...
- id: US-SVC-007-004
  capability: BCM-SVC-007
  title: Configure Sample Catalog
  story: As an administrator, I want to configure Sample Catalog according to laboratory
...
- id: US-SVC-007-005
  capability: BCM-SVC-007
  title: Report Sample Catalog
  story: As a manager, I want to view indicators for Sample Catalog so that I can
