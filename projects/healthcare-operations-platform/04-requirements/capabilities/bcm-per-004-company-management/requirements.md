# BCM-PER-004 — Company Management Requirements

**Spanish:** Gestión de Empresas
...
The platform shall manage master data for gestión de empresas, avoiding duplicate person records across roles.
...
The platform shall support search, registration, update, deactivation and audit of gestión de empresas.
...
The platform shall allow authorized users to link gestión de empresas to clinical, administrative and portal workflows.
...
The platform shall expose privacy-safe views of gestión de empresas according to user role, consent and authorization.
...
### US-PER-004-001 — Manage Company Management

As an authorized user, I want to manage Company Management so that the organization can operate this capability consistently.
...
### US-PER-004-002 — Search Company Management

As an authorized user, I want to search and filter Company Management so that I can find records quickly.
...
### US-PER-004-003 — Audit Company Management

As a supervisor, I want to review the audit history of Company Management so that I can verify accountability and compliance.
...
### US-PER-004-004 — Configure Company Management

As an administrator, I want to configure Company Management according to laboratory and branch rules so that the workflow fits operational needs.
...
### US-PER-004-005 — Report Company Management

As a manager, I want to view indicators for Company Management so that I can make operational decisions.
...
artifact:
  ...
  name: Company Management Requirements
  version: 1.0.0
  status: approved
  owner: Product Requirements Team
  source_of_truth: 04-requirements/capabilities/bcm-per-004-company-management/requirements.md
  depends_on:
  - BCM-PER-004
  - BCM-001
capability:
...
- id: US-PER-004-001
  capability: BCM-PER-004
  title: Manage Company Management
  story: As an authorized user, I want to manage Company Management so that the organization
...
- id: US-PER-004-002
  capability: BCM-PER-004
  title: Search Company Management
  story: As an authorized user, I want to search and filter Company Management so
...
- id: US-PER-004-003
  capability: BCM-PER-004
  title: Audit Company Management
  story: As a supervisor, I want to review the audit history of Company Management
...
- id: US-PER-004-004
  capability: BCM-PER-004
  title: Configure Company Management
  story: As an administrator, I want to configure Company Management according to
...
- id: US-PER-004-005
  capability: BCM-PER-004
  title: Report Company Management
  story: As a manager, I want to view indicators for Company Management so that I
