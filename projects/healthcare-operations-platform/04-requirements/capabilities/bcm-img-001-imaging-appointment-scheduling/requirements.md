# BCM-IMG-001 — Imaging Appointment Scheduling Requirements

**Spanish:** Agenda de Estudios
...
The platform shall support operational management of agenda de estudios for imaging centers and branches.
...
The platform shall integrate Imaging Appointment Scheduling workflows with orders, results, patient portal and doctor portal.
...
### US-IMG-001-001 — Manage Imaging Appointment Scheduling

As an authorized user, I want to manage Imaging Appointment Scheduling so that the organization can operate this capability consistently.
...
### US-IMG-001-002 — Search Imaging Appointment Scheduling

As an authorized user, I want to search and filter Imaging Appointment Scheduling so that I can find records quickly.
...
### US-IMG-001-003 — Audit Imaging Appointment Scheduling

As a supervisor, I want to review the audit history of Imaging Appointment Scheduling so that I can verify accountability and compliance.
...
### US-IMG-001-004 — Configure Imaging Appointment Scheduling

As an administrator, I want to configure Imaging Appointment Scheduling according to laboratory and branch rules so that the workflow fits operational needs.
...
### US-IMG-001-005 — Report Imaging Appointment Scheduling

As a manager, I want to view indicators for Imaging Appointment Scheduling so that I can make operational decisions.
...
artifact:
  ...
  name: Imaging Appointment Scheduling Requirements
  version: 1.0.0
  status: approved
  owner: Product Requirements Team
  source_of_truth: 04-requirements/capabilities/bcm-img-001-imaging-appointment-scheduling/requirements.md
  depends_on:
  - BCM-IMG-001
  - BCM-001
capability:
  ...
  domain_name: Imaging
  id: BCM-IMG-001
  name_en: Imaging Appointment Scheduling
  name_es: Agenda de Estudios
  priority: High
  roadmap: MVP2
actors:
- Radiology Technician
...
- id: US-IMG-001-001
  capability: BCM-IMG-001
  title: Manage Imaging Appointment Scheduling
  story: As an authorized user, I want to manage Imaging Appointment Scheduling so
...
- id: US-IMG-001-002
  capability: BCM-IMG-001
  title: Search Imaging Appointment Scheduling
  story: As an authorized user, I want to search and filter Imaging Appointment Scheduling
...
- id: US-IMG-001-003
  capability: BCM-IMG-001
  title: Audit Imaging Appointment Scheduling
  story: As a supervisor, I want to review the audit history of Imaging Appointment
    Scheduling so that I can verify accountability and compliance.
  priority: High
  roadmap: MVP2
  acceptance_criteria:
  - 'Scenario: authorized access is allowed and unauthorized access is denied.'
...
- id: US-IMG-001-004
  capability: BCM-IMG-001
  title: Configure Imaging Appointment Scheduling
  story: As an administrator, I want to configure Imaging Appointment Scheduling according
...
- id: US-IMG-001-005
  capability: BCM-IMG-001
  title: Report Imaging Appointment Scheduling
  story: As a manager, I want to view indicators for Imaging Appointment Scheduling
