# BCM-INV-002 — Reagent Management Requirements
...
The platform shall manage reactivos with branch-level stock control, lot traceability and expiration handling.
...
The platform shall record stock movements, responsible users and business justification for reactivos.
...
The platform shall relate Reagent Management to diagnostic services and quality workflows when applicable.
...
### US-INV-002-001 — Manage Reagent Management

As an authorized user, I want to manage Reagent Management so that the organization can operate this capability consistently.
...
### US-INV-002-002 — Search Reagent Management

As an authorized user, I want to search and filter Reagent Management so that I can find records quickly.
...
### US-INV-002-003 — Audit Reagent Management

As a supervisor, I want to review the audit history of Reagent Management so that I can verify accountability and compliance.
...
### US-INV-002-004 — Configure Reagent Management

As an administrator, I want to configure Reagent Management according to laboratory and branch rules so that the workflow fits operational needs.
...
### US-INV-002-005 — Report Reagent Management

As a manager, I want to view indicators for Reagent Management so that I can make operational decisions.
