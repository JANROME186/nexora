# BCM-IMG-002 — Imaging Reception Requirements

**Spanish:** Recepción Imagenológica
...
The platform shall support operational management of recepción imagenológica for imaging centers and branches.
...
The platform shall integrate Imaging Reception workflows with orders, results, patient portal and doctor portal.
...
### US-IMG-002-001 — Manage Imaging Reception

As an authorized user, I want to manage Imaging Reception so that the organization can operate this capability consistently.
...
### US-IMG-002-002 — Search Imaging Reception

As an authorized user, I want to search and filter Imaging Reception so that I can find records quickly.
...
### US-IMG-002-003 — Audit Imaging Reception

As a supervisor, I want to review the audit history of Imaging Reception so that I can verify accountability and compliance.
...
### US-IMG-002-004 — Configure Imaging Reception

As an administrator, I want to configure Imaging Reception according to laboratory and branch rules so that the workflow fits operational needs.
...
### US-IMG-002-005 — Report Imaging Reception

As a manager, I want to view indicators for Imaging Reception so that I can make operational decisions.
...
artifact:
  ...
  name: Imaging Reception Requirements
  version: 1.0.0
  status: approved
  owner: Product Requirements Team
  source_of_truth: 04-requirements/capabilities/bcm-img-002-imaging-reception/requirements.md
  depends_on:
  - BCM-IMG-002
  - BCM-001
capability:
  ...
  domain_name: Imaging
  id: BCM-IMG-002
  name_en: Imaging Reception
  name_es: Recepción Imagenológica
  priority: High
  roadmap: MVP2
actors:
- Radiology Technician
...
- id: US-IMG-002-001
  capability: BCM-IMG-002
  title: Manage Imaging Reception
  story: As an authorized user, I want to manage Imaging Reception so that the organization
...
- id: US-IMG-002-002
  capability: BCM-IMG-002
  title: Search Imaging Reception
  story: As an authorized user, I want to search and filter Imaging Reception so that
...
- id: US-IMG-002-003
  capability: BCM-IMG-002
  title: Audit Imaging Reception
  story: As a supervisor, I want to review the audit history of Imaging Reception
...
- id: US-IMG-002-004
  capability: BCM-IMG-002
  title: Configure Imaging Reception
  story: As an administrator, I want to configure Imaging Reception according to laboratory
...
- id: US-IMG-002-005
  capability: BCM-IMG-002
  title: Report Imaging Reception
  story: As a manager, I want to view indicators for Imaging Reception so that I can
