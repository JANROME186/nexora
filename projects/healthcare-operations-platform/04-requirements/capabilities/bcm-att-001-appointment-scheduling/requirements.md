# BCM-ATT-001 — Appointment Scheduling Requirements
...
The platform shall support end-to-end execution of agenda at branch level.
...
The platform shall validate patient, branch, service, user and payment prerequisites before completing agenda.
...
The platform shall record operational and financial audit events for agenda.
...
The platform shall provide user-friendly web workflows for agenda optimized for reception and cashier operations.
...
The platform shall expose Appointment Scheduling status changes to downstream clinical, billing, notification and reporting workflows.
...
### US-ATT-001-001 — Manage Appointment Scheduling

As an authorized user, I want to manage Appointment Scheduling so that the organization can operate this capability consistently.
...
### US-ATT-001-002 — Search Appointment Scheduling

As an authorized user, I want to search and filter Appointment Scheduling so that I can find records quickly.
...
### US-ATT-001-003 — Audit Appointment Scheduling

As a supervisor, I want to review the audit history of Appointment Scheduling so that I can verify accountability and compliance.
...
### US-ATT-001-004 — Configure Appointment Scheduling

As an administrator, I want to configure Appointment Scheduling according to laboratory and branch rules so that the workflow fits operational needs.
...
### US-ATT-001-005 — Report Appointment Scheduling

As a manager, I want to view indicators for Appointment Scheduling so that I can make operational decisions.
...
artifact:
  ...
  name: Appointment Scheduling Requirements
  version: 1.0.0
  status: approved
  owner: Product Requirements Team
  source_of_truth: 04-requirements/capabilities/bcm-att-001-appointment-scheduling/requirements.md
  depends_on:
  - BCM-ATT-001
  - BCM-001
capability:
  ...
  id: BCM-ATT-001
  name_en: Appointment Scheduling
  name_es: Agenda
  priority: High
  roadmap: MVP1
actors:
...
- id: US-ATT-001-001
  ...
  story: As an authorized user, I want to manage Appointment Scheduling so that the
...
- id: US-ATT-001-002
  capability: BCM-ATT-001
  title: Search Appointment Scheduling
  story: As an authorized user, I want to search and filter Appointment Scheduling
...
- id: US-ATT-001-003
  capability: BCM-ATT-001
  title: Audit Appointment Scheduling
  story: As a supervisor, I want to review the audit history of Appointment Scheduling
...
- id: US-ATT-001-004
  capability: BCM-ATT-001
  title: Configure Appointment Scheduling
  story: As an administrator, I want to configure Appointment Scheduling according
...
- id: US-ATT-001-005
  capability: BCM-ATT-001
  title: Report Appointment Scheduling
  story: As a manager, I want to view indicators for Appointment Scheduling so that
