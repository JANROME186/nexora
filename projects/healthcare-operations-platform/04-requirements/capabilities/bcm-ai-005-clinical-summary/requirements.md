# BCM-AI-005 — Clinical Summary Requirements

**Spanish:** Resumen Clínico
...
The platform shall provide resumen clínico as an AI-assisted capability with human oversight where clinical or administrative risk exists.
...
### US-AI-005-001 — Manage Clinical Summary

As an authorized user, I want to manage Clinical Summary so that the organization can operate this capability consistently.
...
### US-AI-005-002 — Search Clinical Summary

As an authorized user, I want to search and filter Clinical Summary so that I can find records quickly.
...
### US-AI-005-003 — Audit Clinical Summary

As a supervisor, I want to review the audit history of Clinical Summary so that I can verify accountability and compliance.
...
### US-AI-005-004 — Configure Clinical Summary

As an administrator, I want to configure Clinical Summary according to laboratory and branch rules so that the workflow fits operational needs.
...
### US-AI-005-005 — Report Clinical Summary

As a manager, I want to view indicators for Clinical Summary so that I can make operational decisions.
...
artifact:
  ...
  name: Clinical Summary Requirements
  version: 1.0.0
  status: approved
  owner: Product Requirements Team
  source_of_truth: 04-requirements/capabilities/bcm-ai-005-clinical-summary/requirements.md
  depends_on:
  - BCM-AI-005
  - BCM-001
capability:
  ...
  id: BCM-AI-005
  name_en: Clinical Summary
  name_es: Resumen Clínico
  priority: High
  roadmap: MVP3
actors:
- AI Operator
...
- id: US-AI-005-001
  capability: BCM-AI-005
  title: Manage Clinical Summary
  story: As an authorized user, I want to manage Clinical Summary so that the organization
...
- id: US-AI-005-002
  capability: BCM-AI-005
  title: Search Clinical Summary
  story: As an authorized user, I want to search and filter Clinical Summary so that
...
- id: US-AI-005-003
  capability: BCM-AI-005
  title: Audit Clinical Summary
  story: As a supervisor, I want to review the audit history of Clinical Summary so
...
- id: US-AI-005-004
  capability: BCM-AI-005
  title: Configure Clinical Summary
  story: As an administrator, I want to configure Clinical Summary according to laboratory
...
- id: US-AI-005-005
  capability: BCM-AI-005
  title: Report Clinical Summary
  story: As a manager, I want to view indicators for Clinical Summary so that I can
