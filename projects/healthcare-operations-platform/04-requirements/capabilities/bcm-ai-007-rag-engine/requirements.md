# BCM-AI-007 — RAG Engine Requirements
...
The platform shall provide motor rag as an AI-assisted capability with human oversight where clinical or administrative risk exists.
...
### US-AI-007-001 — Manage RAG Engine

As an authorized user, I want to manage RAG Engine so that the organization can operate this capability consistently.
...
### US-AI-007-002 — Search RAG Engine

As an authorized user, I want to search and filter RAG Engine so that I can find records quickly.
...
### US-AI-007-003 — Audit RAG Engine

As a supervisor, I want to review the audit history of RAG Engine so that I can verify accountability and compliance.
...
### US-AI-007-004 — Configure RAG Engine

As an administrator, I want to configure RAG Engine according to laboratory and branch rules so that the workflow fits operational needs.
...
### US-AI-007-005 — Report RAG Engine

As a manager, I want to view indicators for RAG Engine so that I can make operational decisions.
...
artifact:
  ...
  name: RAG Engine Requirements
  version: 1.0.0
  status: approved
  owner: Product Requirements Team
  source_of_truth: 04-requirements/capabilities/bcm-ai-007-rag-engine/requirements.md
  depends_on:
  - BCM-AI-007
  - BCM-001
capability:
...
- id: US-AI-007-001
  capability: BCM-AI-007
  title: Manage RAG Engine
  story: As an authorized user, I want to manage RAG Engine so that the organization
...
- id: US-AI-007-002
  capability: BCM-AI-007
  title: Search RAG Engine
  story: As an authorized user, I want to search and filter RAG Engine so that I can
...
- id: US-AI-007-003
  ...
  story: As a supervisor, I want to review the audit history of RAG Engine so that
...
- id: US-AI-007-004
  capability: BCM-AI-007
  title: Configure RAG Engine
  story: As an administrator, I want to configure RAG Engine according to laboratory
...
- id: US-AI-007-005
  capability: BCM-AI-007
  title: Report RAG Engine
  story: As a manager, I want to view indicators for RAG Engine so that I can make
