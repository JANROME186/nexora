# BCM-LAB-003 — Sample Labeling Requirements
...
The platform shall support traceable execution of etiquetado from diagnostic order to result lifecycle.
...
The platform shall enforce sample, test, branch and user authorization rules before allowing etiquetado.
...
The platform shall record timestamps, responsible users, exceptions and status transitions for etiquetado.
...
### US-LAB-003-001 — Manage Sample Labeling

As an authorized user, I want to manage Sample Labeling so that the organization can operate this capability consistently.
...
### US-LAB-003-002 — Search Sample Labeling

As an authorized user, I want to search and filter Sample Labeling so that I can find records quickly.
...
### US-LAB-003-003 — Audit Sample Labeling

As a supervisor, I want to review the audit history of Sample Labeling so that I can verify accountability and compliance.
...
### US-LAB-003-004 — Configure Sample Labeling

As an administrator, I want to configure Sample Labeling according to laboratory and branch rules so that the workflow fits operational needs.
...
### US-LAB-003-005 — Report Sample Labeling

As a manager, I want to view indicators for Sample Labeling so that I can make operational decisions.
...
artifact:
  ...
  name: Sample Labeling Requirements
  version: 1.0.0
  status: approved
  owner: Product Requirements Team
  source_of_truth: 04-requirements/capabilities/bcm-lab-003-sample-labeling/requirements.md
  depends_on:
  - BCM-LAB-003
  - BCM-001
capability:
...
- id: US-LAB-003-001
  capability: BCM-LAB-003
  title: Manage Sample Labeling
  story: As an authorized user, I want to manage Sample Labeling so that the organization
...
- id: US-LAB-003-002
  capability: BCM-LAB-003
  title: Search Sample Labeling
  story: As an authorized user, I want to search and filter Sample Labeling so that
...
- id: US-LAB-003-003
  capability: BCM-LAB-003
  title: Audit Sample Labeling
  story: As a supervisor, I want to review the audit history of Sample Labeling so
...
- id: US-LAB-003-004
  capability: BCM-LAB-003
  title: Configure Sample Labeling
  story: As an administrator, I want to configure Sample Labeling according to laboratory
...
- id: US-LAB-003-005
  capability: BCM-LAB-003
  title: Report Sample Labeling
  story: As a manager, I want to view indicators for Sample Labeling so that I can
