# BCM-SVC-009 — Price List Management Requirements
...
The platform shall allow authorized users to configure and version tarifario.
...
The platform shall prevent clinical use of incomplete, inactive or deprecated tarifario.
...
The platform shall support effective dates, branch availability and pricing relationships for tarifario.
...
The platform shall track changes to tarifario and preserve the version used by each diagnostic order.
...
The platform shall expose Price List Management configuration through APIs used by ordering, results, billing and inventory.
...
### US-SVC-009-001 — Manage Price List Management

As an authorized user, I want to manage Price List Management so that the organization can operate this capability consistently.
...
### US-SVC-009-002 — Search Price List Management

As an authorized user, I want to search and filter Price List Management so that I can find records quickly.
...
### US-SVC-009-003 — Audit Price List Management

As a supervisor, I want to review the audit history of Price List Management so that I can verify accountability and compliance.
...
### US-SVC-009-004 — Configure Price List Management

As an administrator, I want to configure Price List Management according to laboratory and branch rules so that the workflow fits operational needs.
...
### US-SVC-009-005 — Report Price List Management

As a manager, I want to view indicators for Price List Management so that I can make operational decisions.
...
artifact:
  ...
  name: Price List Management Requirements
  version: 1.0.0
  status: approved
  owner: Product Requirements Team
  source_of_truth: 04-requirements/capabilities/bcm-svc-009-price-list-management/requirements.md
  depends_on:
  - BCM-SVC-009
  - BCM-001
capability:
...
- id: US-SVC-009-001
  capability: BCM-SVC-009
  title: Manage Price List Management
  story: As an authorized user, I want to manage Price List Management so that the
...
- id: US-SVC-009-002
  capability: BCM-SVC-009
  title: Search Price List Management
  story: As an authorized user, I want to search and filter Price List Management
...
- id: US-SVC-009-003
  capability: BCM-SVC-009
  title: Audit Price List Management
  story: As a supervisor, I want to review the audit history of Price List Management
...
- id: US-SVC-009-004
  capability: BCM-SVC-009
  title: Configure Price List Management
  story: As an administrator, I want to configure Price List Management according
...
- id: US-SVC-009-005
  capability: BCM-SVC-009
  title: Report Price List Management
  story: As a manager, I want to view indicators for Price List Management so that
