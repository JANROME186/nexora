# BCM-ATT-003 — Reception Management Requirements
...
The platform shall support end-to-end execution of recepción at branch level.
...
The platform shall validate patient, branch, service, user and payment prerequisites before completing recepción.
...
The platform shall record operational and financial audit events for recepción.
...
The platform shall provide user-friendly web workflows for recepción optimized for reception and cashier operations.
...
The platform shall expose Reception Management status changes to downstream clinical, billing, notification and reporting workflows.
...
### US-ATT-003-001 — Manage Reception Management

As an authorized user, I want to manage Reception Management so that the organization can operate this capability consistently.
...
### US-ATT-003-002 — Search Reception Management

As an authorized user, I want to search and filter Reception Management so that I can find records quickly.
...
### US-ATT-003-003 — Audit Reception Management

As a supervisor, I want to review the audit history of Reception Management so that I can verify accountability and compliance.
...
### US-ATT-003-004 — Configure Reception Management

As an administrator, I want to configure Reception Management according to laboratory and branch rules so that the workflow fits operational needs.
...
### US-ATT-003-005 — Report Reception Management

As a manager, I want to view indicators for Reception Management so that I can make operational decisions.
...
artifact:
  ...
  name: Reception Management Requirements
  version: 1.0.0
  status: approved
  owner: Product Requirements Team
  source_of_truth: 04-requirements/capabilities/bcm-att-003-reception-management/requirements.md
  depends_on:
  - BCM-ATT-003
  - BCM-001
capability:
...
- id: US-ATT-003-001
  capability: BCM-ATT-003
  title: Manage Reception Management
  story: As an authorized user, I want to manage Reception Management so that the
...
- id: US-ATT-003-002
  capability: BCM-ATT-003
  title: Search Reception Management
  story: As an authorized user, I want to search and filter Reception Management so
...
- id: US-ATT-003-003
  capability: BCM-ATT-003
  title: Audit Reception Management
  story: As a supervisor, I want to review the audit history of Reception Management
...
- id: US-ATT-003-004
  capability: BCM-ATT-003
  title: Configure Reception Management
  story: As an administrator, I want to configure Reception Management according to
...
- id: US-ATT-003-005
  capability: BCM-ATT-003
  title: Report Reception Management
  story: As a manager, I want to view indicators for Reception Management so that
