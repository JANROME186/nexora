# BCM-INV-004 — Procurement Management Requirements
...
The platform shall manage compras with branch-level stock control, lot traceability and expiration handling.
...
The platform shall record stock movements, responsible users and business justification for compras.
...
The platform shall relate Procurement Management to diagnostic services and quality workflows when applicable.
...
### US-INV-004-001 — Manage Procurement Management

As an authorized user, I want to manage Procurement Management so that the organization can operate this capability consistently.
...
### US-INV-004-002 — Search Procurement Management

As an authorized user, I want to search and filter Procurement Management so that I can find records quickly.
...
### US-INV-004-003 — Audit Procurement Management

As a supervisor, I want to review the audit history of Procurement Management so that I can verify accountability and compliance.
...
### US-INV-004-004 — Configure Procurement Management

As an administrator, I want to configure Procurement Management according to laboratory and branch rules so that the workflow fits operational needs.
...
### US-INV-004-005 — Report Procurement Management

As a manager, I want to view indicators for Procurement Management so that I can make operational decisions.
...
artifact:
  ...
  name: Procurement Management Requirements
  version: 1.0.0
  status: approved
  owner: Product Requirements Team
  source_of_truth: 04-requirements/capabilities/bcm-inv-004-procurement-management/requirements.md
  depends_on:
  - BCM-INV-004
  - BCM-001
capability:
  ...
  id: BCM-INV-004
  name_en: Procurement Management
  name_es: Compras
  priority: High
  roadmap: MVP2
actors:
...
- id: US-INV-004-001
  ...
  story: As an authorized user, I want to manage Procurement Management so that the
...
- id: US-INV-004-002
  capability: BCM-INV-004
  title: Search Procurement Management
  story: As an authorized user, I want to search and filter Procurement Management
...
- id: US-INV-004-003
  capability: BCM-INV-004
  title: Audit Procurement Management
  story: As a supervisor, I want to review the audit history of Procurement Management
...
- id: US-INV-004-004
  capability: BCM-INV-004
  title: Configure Procurement Management
  story: As an administrator, I want to configure Procurement Management according
...
- id: US-INV-004-005
  capability: BCM-INV-004
  title: Report Procurement Management
  story: As a manager, I want to view indicators for Procurement Management so that
