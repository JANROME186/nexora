# BCM-PER-003 — Doctor Management Requirements

**Spanish:** Gestión de Médicos
...
The platform shall manage master data for gestión de médicos, avoiding duplicate person records across roles.
...
The platform shall support search, registration, update, deactivation and audit of gestión de médicos.
...
The platform shall allow authorized users to link gestión de médicos to clinical, administrative and portal workflows.
...
The platform shall expose privacy-safe views of gestión de médicos according to user role, consent and authorization.
...
### US-PER-003-001 — Manage Doctor Management

As an authorized user, I want to manage Doctor Management so that the organization can operate this capability consistently.
...
### US-PER-003-002 — Search Doctor Management

As an authorized user, I want to search and filter Doctor Management so that I can find records quickly.
...
### US-PER-003-003 — Audit Doctor Management

As a supervisor, I want to review the audit history of Doctor Management so that I can verify accountability and compliance.
...
### US-PER-003-004 — Configure Doctor Management

As an administrator, I want to configure Doctor Management according to laboratory and branch rules so that the workflow fits operational needs.
...
### US-PER-003-005 — Report Doctor Management

As a manager, I want to view indicators for Doctor Management so that I can make operational decisions.
...
artifact:
  ...
  name: Doctor Management Requirements
  version: 1.0.0
  status: approved
  owner: Product Requirements Team
  source_of_truth: 04-requirements/capabilities/bcm-per-003-doctor-management/requirements.md
  depends_on:
  - BCM-PER-003
  - BCM-001
capability:
  ...
  domain_name: People
  id: BCM-PER-003
  name_en: Doctor Management
  name_es: Gestión de Médicos
  priority: High
  roadmap: MVP1
actors:
- Receptionist
...
- id: US-PER-003-001
  capability: BCM-PER-003
  title: Manage Doctor Management
  story: As an authorized user, I want to manage Doctor Management so that the organization
...
- id: US-PER-003-002
  capability: BCM-PER-003
  title: Search Doctor Management
  story: As an authorized user, I want to search and filter Doctor Management so that
...
- id: US-PER-003-003
  capability: BCM-PER-003
  title: Audit Doctor Management
  story: As a supervisor, I want to review the audit history of Doctor Management
...
- id: US-PER-003-004
  capability: BCM-PER-003
  title: Configure Doctor Management
  story: As an administrator, I want to configure Doctor Management according to laboratory
...
- id: US-PER-003-005
  capability: BCM-PER-003
  title: Report Doctor Management
  story: As a manager, I want to view indicators for Doctor Management so that I can
