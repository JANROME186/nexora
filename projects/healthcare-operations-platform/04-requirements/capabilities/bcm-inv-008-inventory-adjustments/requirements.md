# BCM-INV-008 — Inventory Adjustments Requirements
...
The platform shall manage ajustes with branch-level stock control, lot traceability and expiration handling.
...
The platform shall record stock movements, responsible users and business justification for ajustes.
...
The platform shall relate Inventory Adjustments to diagnostic services and quality workflows when applicable.
...
### US-INV-008-001 — Manage Inventory Adjustments

As an authorized user, I want to manage Inventory Adjustments so that the organization can operate this capability consistently.
...
### US-INV-008-002 — Search Inventory Adjustments

As an authorized user, I want to search and filter Inventory Adjustments so that I can find records quickly.
...
### US-INV-008-003 — Audit Inventory Adjustments

As a supervisor, I want to review the audit history of Inventory Adjustments so that I can verify accountability and compliance.
...
### US-INV-008-004 — Configure Inventory Adjustments

As an administrator, I want to configure Inventory Adjustments according to laboratory and branch rules so that the workflow fits operational needs.
...
### US-INV-008-005 — Report Inventory Adjustments

As a manager, I want to view indicators for Inventory Adjustments so that I can make operational decisions.
...
artifact:
  ...
  name: Inventory Adjustments Requirements
  version: 1.0.0
  status: approved
  owner: Product Requirements Team
  source_of_truth: 04-requirements/capabilities/bcm-inv-008-inventory-adjustments/requirements.md
  depends_on:
  - BCM-INV-008
  - BCM-001
capability:
...
- id: US-INV-008-001
  ...
  story: As an authorized user, I want to manage Inventory Adjustments so that the
...
- id: US-INV-008-002
  capability: BCM-INV-008
  title: Search Inventory Adjustments
  story: As an authorized user, I want to search and filter Inventory Adjustments
...
- id: US-INV-008-003
  capability: BCM-INV-008
  title: Audit Inventory Adjustments
  story: As a supervisor, I want to review the audit history of Inventory Adjustments
...
- id: US-INV-008-004
  capability: BCM-INV-008
  title: Configure Inventory Adjustments
  story: As an administrator, I want to configure Inventory Adjustments according
...
- id: US-INV-008-005
  capability: BCM-INV-008
  title: Report Inventory Adjustments
  story: As a manager, I want to view indicators for Inventory Adjustments so that
