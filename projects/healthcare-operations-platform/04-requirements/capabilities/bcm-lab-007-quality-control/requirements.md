# BCM-LAB-007 — Quality Control Requirements
...
The platform shall support traceable execution of control de calidad from diagnostic order to result lifecycle.
...
The platform shall enforce sample, test, branch and user authorization rules before allowing control de calidad.
...
The platform shall record timestamps, responsible users, exceptions and status transitions for control de calidad.
...
### US-LAB-007-001 — Manage Quality Control

As an authorized user, I want to manage Quality Control so that the organization can operate this capability consistently.
...
### US-LAB-007-002 — Search Quality Control

As an authorized user, I want to search and filter Quality Control so that I can find records quickly.
...
### US-LAB-007-003 — Audit Quality Control

As a supervisor, I want to review the audit history of Quality Control so that I can verify accountability and compliance.
...
### US-LAB-007-004 — Configure Quality Control

As an administrator, I want to configure Quality Control according to laboratory and branch rules so that the workflow fits operational needs.
...
### US-LAB-007-005 — Report Quality Control

As a manager, I want to view indicators for Quality Control so that I can make operational decisions.
...
artifact:
  ...
  source_of_truth: 04-requirements/capabilities/bcm-lab-007-quality-control/requirements.md
  depends_on:
  - BCM-LAB-007
  - BCM-001
capability:
...
- id: US-LAB-007-001
  capability: BCM-LAB-007
  title: Manage Quality Control
  story: As an authorized user, I want to manage Quality Control so that the organization
...
- id: US-LAB-007-002
  ...
  story: As an authorized user, I want to search and filter Quality Control so that
...
- id: US-LAB-007-003
  ...
  story: As a supervisor, I want to review the audit history of Quality Control so
...
- id: US-LAB-007-004
  capability: BCM-LAB-007
  title: Configure Quality Control
  story: As an administrator, I want to configure Quality Control according to laboratory
...
- id: US-LAB-007-005
  ...
  story: As a manager, I want to view indicators for Quality Control so that I can
