# BCM-ATT-007 — Promotion Management Requirements
...
The platform shall support end-to-end execution of promociones at branch level.
...
The platform shall validate patient, branch, service, user and payment prerequisites before completing promociones.
...
The platform shall record operational and financial audit events for promociones.
...
The platform shall provide user-friendly web workflows for promociones optimized for reception and cashier operations.
...
The platform shall expose Promotion Management status changes to downstream clinical, billing, notification and reporting workflows.
...
### US-ATT-007-001 — Manage Promotion Management

As an authorized user, I want to manage Promotion Management so that the organization can operate this capability consistently.
...
### US-ATT-007-002 — Search Promotion Management

As an authorized user, I want to search and filter Promotion Management so that I can find records quickly.
...
### US-ATT-007-003 — Audit Promotion Management

As a supervisor, I want to review the audit history of Promotion Management so that I can verify accountability and compliance.
...
### US-ATT-007-004 — Configure Promotion Management

As an administrator, I want to configure Promotion Management according to laboratory and branch rules so that the workflow fits operational needs.
...
### US-ATT-007-005 — Report Promotion Management

As a manager, I want to view indicators for Promotion Management so that I can make operational decisions.
...
artifact:
  ...
  name: Promotion Management Requirements
  version: 1.0.0
  status: approved
  owner: Product Requirements Team
  source_of_truth: 04-requirements/capabilities/bcm-att-007-promotion-management/requirements.md
  depends_on:
  - BCM-ATT-007
  - BCM-001
capability:
...
- id: US-ATT-007-001
  capability: BCM-ATT-007
  title: Manage Promotion Management
  story: As an authorized user, I want to manage Promotion Management so that the
...
- id: US-ATT-007-002
  capability: BCM-ATT-007
  title: Search Promotion Management
  story: As an authorized user, I want to search and filter Promotion Management so
...
- id: US-ATT-007-003
  capability: BCM-ATT-007
  title: Audit Promotion Management
  story: As a supervisor, I want to review the audit history of Promotion Management
...
- id: US-ATT-007-004
  capability: BCM-ATT-007
  title: Configure Promotion Management
  story: As an administrator, I want to configure Promotion Management according to
...
- id: US-ATT-007-005
  capability: BCM-ATT-007
  title: Report Promotion Management
  story: As a manager, I want to view indicators for Promotion Management so that
