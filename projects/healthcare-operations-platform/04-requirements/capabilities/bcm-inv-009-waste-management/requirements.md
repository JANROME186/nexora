# BCM-INV-009 — Waste Management Requirements
...
The platform shall manage mermas with branch-level stock control, lot traceability and expiration handling.
...
The platform shall record stock movements, responsible users and business justification for mermas.
...
The platform shall relate Waste Management to diagnostic services and quality workflows when applicable.
...
### US-INV-009-001 — Manage Waste Management

As an authorized user, I want to manage Waste Management so that the organization can operate this capability consistently.
...
### US-INV-009-002 — Search Waste Management

As an authorized user, I want to search and filter Waste Management so that I can find records quickly.
...
### US-INV-009-003 — Audit Waste Management

As a supervisor, I want to review the audit history of Waste Management so that I can verify accountability and compliance.
...
### US-INV-009-004 — Configure Waste Management

As an administrator, I want to configure Waste Management according to laboratory and branch rules so that the workflow fits operational needs.
...
### US-INV-009-005 — Report Waste Management

As a manager, I want to view indicators for Waste Management so that I can make operational decisions.
...
artifact:
  ...
  name: Waste Management Requirements
  version: 1.0.0
  status: approved
  owner: Product Requirements Team
  source_of_truth: 04-requirements/capabilities/bcm-inv-009-waste-management/requirements.md
  depends_on:
  - BCM-INV-009
  - BCM-001
capability:
...
- id: US-INV-009-001
  capability: BCM-INV-009
  title: Manage Waste Management
  story: As an authorized user, I want to manage Waste Management so that the organization
...
- id: US-INV-009-002
  capability: BCM-INV-009
  title: Search Waste Management
  story: As an authorized user, I want to search and filter Waste Management so that
...
- id: US-INV-009-003
  capability: BCM-INV-009
  title: Audit Waste Management
  story: As a supervisor, I want to review the audit history of Waste Management so
...
- id: US-INV-009-004
  capability: BCM-INV-009
  title: Configure Waste Management
  story: As an administrator, I want to configure Waste Management according to laboratory
...
- id: US-INV-009-005
  capability: BCM-INV-009
  title: Report Waste Management
  story: As a manager, I want to view indicators for Waste Management so that I can
