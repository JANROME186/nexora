# BCM-AI-006 — Semantic Search Requirements

**Spanish:** Búsqueda Semántica
...
The platform shall provide búsqueda semántica as an AI-assisted capability with human oversight where clinical or administrative risk exists.
...
### US-AI-006-001 — Manage Semantic Search

As an authorized user, I want to manage Semantic Search so that the organization can operate this capability consistently.
...
### US-AI-006-002 — Search Semantic Search

As an authorized user, I want to search and filter Semantic Search so that I can find records quickly.
...
### US-AI-006-003 — Audit Semantic Search

As a supervisor, I want to review the audit history of Semantic Search so that I can verify accountability and compliance.
...
### US-AI-006-004 — Configure Semantic Search

As an administrator, I want to configure Semantic Search according to laboratory and branch rules so that the workflow fits operational needs.
...
### US-AI-006-005 — Report Semantic Search

As a manager, I want to view indicators for Semantic Search so that I can make operational decisions.
...
artifact:
  ...
  name: Semantic Search Requirements
  version: 1.0.0
  status: approved
  owner: Product Requirements Team
  source_of_truth: 04-requirements/capabilities/bcm-ai-006-semantic-search/requirements.md
  depends_on:
  - BCM-AI-006
  - BCM-001
capability:
...
- id: US-AI-006-001
  capability: BCM-AI-006
  title: Manage Semantic Search
  story: As an authorized user, I want to manage Semantic Search so that the organization
...
- id: US-AI-006-002
  ...
  story: As an authorized user, I want to search and filter Semantic Search so that
...
- id: US-AI-006-003
  capability: BCM-AI-006
  title: Audit Semantic Search
  story: As a supervisor, I want to review the audit history of Semantic Search so
...
- id: US-AI-006-004
  ...
  story: As an administrator, I want to configure Semantic Search according to laboratory
...
- id: US-AI-006-005
  capability: BCM-AI-006
  title: Report Semantic Search
  story: As a manager, I want to view indicators for Semantic Search so that I can
