# BCM-ORG-007 — Schedule Management Requirements

**Spanish:** Gestión de Horarios
...
The platform shall allow authorized administrators to create, update, activate, suspend and audit gestión de horarios.
...
The platform shall associate gestión de horarios with the correct tenant, laboratory and branch hierarchy.
...
The platform shall enforce role-based and attribute-based permissions for all gestión de horarios operations.
...
The platform shall preserve historical changes for gestión de horarios using audit metadata and immutable audit events.
...
The platform shall expose Schedule Management capabilities through contract-first APIs and reusable web components.
...
### US-ORG-007-001 — Manage Schedule Management

As an authorized user, I want to manage Schedule Management so that the organization can operate this capability consistently.
...
### US-ORG-007-002 — Search Schedule Management

As an authorized user, I want to search and filter Schedule Management so that I can find records quickly.
...
### US-ORG-007-003 — Audit Schedule Management

As a supervisor, I want to review the audit history of Schedule Management so that I can verify accountability and compliance.
...
### US-ORG-007-004 — Configure Schedule Management

As an administrator, I want to configure Schedule Management according to laboratory and branch rules so that the workflow fits operational needs.
...
### US-ORG-007-005 — Report Schedule Management

As a manager, I want to view indicators for Schedule Management so that I can make operational decisions.
...
artifact:
  ...
  name: Schedule Management Requirements
  version: 1.0.0
  status: approved
  owner: Product Requirements Team
  source_of_truth: 04-requirements/capabilities/bcm-org-007-schedule-management/requirements.md
  depends_on:
  - BCM-ORG-007
  - BCM-001
capability:
...
- id: US-ORG-007-001
  capability: BCM-ORG-007
  title: Manage Schedule Management
  story: As an authorized user, I want to manage Schedule Management so that the organization
...
- id: US-ORG-007-002
  capability: BCM-ORG-007
  title: Search Schedule Management
  story: As an authorized user, I want to search and filter Schedule Management so
...
- id: US-ORG-007-003
  ...
  story: As a supervisor, I want to review the audit history of Schedule Management
...
- id: US-ORG-007-004
  capability: BCM-ORG-007
  title: Configure Schedule Management
  story: As an administrator, I want to configure Schedule Management according to
...
- id: US-ORG-007-005
  capability: BCM-ORG-007
  title: Report Schedule Management
  story: As a manager, I want to view indicators for Schedule Management so that I
