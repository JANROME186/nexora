# BCM-QLT-006 — CAPA Management Requirements
...
The platform shall support documented execution and traceability of capa.
...
The platform shall allow authorized users to record observations, evidence, corrective actions and approvals for capa.
...
The platform shall link capa to equipment, tests, branches, users and affected results where applicable.
...
The platform shall generate audit-ready evidence and reports for capa.
...
### US-QLT-006-001 — Manage CAPA Management

As an authorized user, I want to manage CAPA Management so that the organization can operate this capability consistently.
...
### US-QLT-006-002 — Search CAPA Management

As an authorized user, I want to search and filter CAPA Management so that I can find records quickly.
...
### US-QLT-006-003 — Audit CAPA Management

As a supervisor, I want to review the audit history of CAPA Management so that I can verify accountability and compliance.
...
### US-QLT-006-004 — Configure CAPA Management

As an administrator, I want to configure CAPA Management according to laboratory and branch rules so that the workflow fits operational needs.
...
### US-QLT-006-005 — Report CAPA Management

As a manager, I want to view indicators for CAPA Management so that I can make operational decisions.
...
artifact:
  ...
  name: CAPA Management Requirements
  version: 1.0.0
  status: approved
  owner: Product Requirements Team
  source_of_truth: 04-requirements/capabilities/bcm-qlt-006-capa-management/requirements.md
  depends_on:
  - BCM-QLT-006
  - BCM-001
capability:
...
- id: US-QLT-006-001
  capability: BCM-QLT-006
  title: Manage CAPA Management
  story: As an authorized user, I want to manage CAPA Management so that the organization
...
- id: US-QLT-006-002
  capability: BCM-QLT-006
  title: Search CAPA Management
  story: As an authorized user, I want to search and filter CAPA Management so that
...
- id: US-QLT-006-003
  ...
  story: As a supervisor, I want to review the audit history of CAPA Management so
...
- id: US-QLT-006-004
  capability: BCM-QLT-006
  title: Configure CAPA Management
  story: As an administrator, I want to configure CAPA Management according to laboratory
...
- id: US-QLT-006-005
  capability: BCM-QLT-006
  title: Report CAPA Management
  story: As a manager, I want to view indicators for CAPA Management so that I can
