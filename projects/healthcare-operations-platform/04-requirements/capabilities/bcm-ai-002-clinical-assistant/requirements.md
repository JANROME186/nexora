# BCM-AI-002 — Clinical Assistant Requirements

**Spanish:** Asistente Clínico
...
The platform shall provide asistente clínico as an AI-assisted capability with human oversight where clinical or administrative risk exists.
...
### US-AI-002-001 — Manage Clinical Assistant

As an authorized user, I want to manage Clinical Assistant so that the organization can operate this capability consistently.
...
### US-AI-002-002 — Search Clinical Assistant

As an authorized user, I want to search and filter Clinical Assistant so that I can find records quickly.
...
### US-AI-002-003 — Audit Clinical Assistant

As a supervisor, I want to review the audit history of Clinical Assistant so that I can verify accountability and compliance.
...
### US-AI-002-004 — Configure Clinical Assistant

As an administrator, I want to configure Clinical Assistant according to laboratory and branch rules so that the workflow fits operational needs.
...
### US-AI-002-005 — Report Clinical Assistant

As a manager, I want to view indicators for Clinical Assistant so that I can make operational decisions.
...
artifact:
  ...
  name: Clinical Assistant Requirements
  version: 1.0.0
  status: approved
  owner: Product Requirements Team
  source_of_truth: 04-requirements/capabilities/bcm-ai-002-clinical-assistant/requirements.md
  depends_on:
  - BCM-AI-002
  - BCM-001
capability:
  ...
  id: BCM-AI-002
  name_en: Clinical Assistant
  name_es: Asistente Clínico
  priority: High
  roadmap: MVP3
actors:
- AI Operator
...
- id: US-AI-002-001
  capability: BCM-AI-002
  title: Manage Clinical Assistant
  story: As an authorized user, I want to manage Clinical Assistant so that the organization
...
- id: US-AI-002-002
  capability: BCM-AI-002
  title: Search Clinical Assistant
  story: As an authorized user, I want to search and filter Clinical Assistant so
...
- id: US-AI-002-003
  capability: BCM-AI-002
  title: Audit Clinical Assistant
  story: As a supervisor, I want to review the audit history of Clinical Assistant
...
- id: US-AI-002-004
  capability: BCM-AI-002
  title: Configure Clinical Assistant
  story: As an administrator, I want to configure Clinical Assistant according to
...
- id: US-AI-002-005
  capability: BCM-AI-002
  title: Report Clinical Assistant
  story: As a manager, I want to view indicators for Clinical Assistant so that I
