# BCM-PER-001 — Person Management Requirements

**Spanish:** Gestión de Personas
...
The platform shall manage master data for gestión de personas, avoiding duplicate person records across roles.
...
The platform shall support search, registration, update, deactivation and audit of gestión de personas.
...
The platform shall allow authorized users to link gestión de personas to clinical, administrative and portal workflows.
...
The platform shall expose privacy-safe views of gestión de personas according to user role, consent and authorization.
...
### US-PER-001-001 — Manage Person Management

As an authorized user, I want to manage Person Management so that the organization can operate this capability consistently.
...
### US-PER-001-002 — Search Person Management

As an authorized user, I want to search and filter Person Management so that I can find records quickly.
...
### US-PER-001-003 — Audit Person Management

As a supervisor, I want to review the audit history of Person Management so that I can verify accountability and compliance.
...
### US-PER-001-004 — Configure Person Management

As an administrator, I want to configure Person Management according to laboratory and branch rules so that the workflow fits operational needs.
...
### US-PER-001-005 — Report Person Management

As a manager, I want to view indicators for Person Management so that I can make operational decisions.
...
artifact:
  ...
  name: Person Management Requirements
  version: 1.0.0
  status: approved
  owner: Product Requirements Team
  source_of_truth: 04-requirements/capabilities/bcm-per-001-person-management/requirements.md
  depends_on:
  - BCM-PER-001
  - BCM-001
capability:
  ...
  domain_name: People
  id: BCM-PER-001
  name_en: Person Management
  name_es: Gestión de Personas
  priority: High
  roadmap: MVP1
actors:
- Receptionist
...
- id: US-PER-001-001
  capability: BCM-PER-001
  title: Manage Person Management
  story: As an authorized user, I want to manage Person Management so that the organization
...
- id: US-PER-001-002
  capability: BCM-PER-001
  title: Search Person Management
  story: As an authorized user, I want to search and filter Person Management so that
...
- id: US-PER-001-003
  capability: BCM-PER-001
  title: Audit Person Management
  story: As a supervisor, I want to review the audit history of Person Management
...
- id: US-PER-001-004
  capability: BCM-PER-001
  title: Configure Person Management
  story: As an administrator, I want to configure Person Management according to laboratory
...
- id: US-PER-001-005
  capability: BCM-PER-001
  title: Report Person Management
  story: As a manager, I want to view indicators for Person Management so that I can
