...
total_completed_deliverables: 135
payload_hash: '277579999803'
completed_deliverables:
- HOP-HARD-APP-001 Mobile, patient portal, doctor portal and imaging delivery hardening (closed COM-MOD-014-PORTAL-001: patient-portal and doctor-portal each gained a read-only Imaging tab against the existing BCM-IMG-007/BCM-IMG-008 backend, following the callerRoleCode/callerId self-access convention already established for laboratory results; found and fixed a real pre-existing authorization gap along the way -- ImagingStudyDeliveryController/RadiologySignatureController had zero patient/doctor-role-scoped authorization before this item, fixed with 2 new permission codes, 2 new HopAuthorizationInterceptor self-access bypass blocks and new service-layer ownership checks reusing ReferringDoctorAuthorizationPort; TD-APP-001 re-verified materially_reduced_unchanged (corrected a stale 569-line mobile-app size figure to the actual 1,158/2,172), TD-UX-003 reviewed genuinely still blocked; remediated a pre-existing high-severity npm audit finding in patient-portal/doctor-portal/mobile-app; all 4 touched stacks (backend 84.86%, patient-portal 94.42%, doctor-portal 96.55%, mobile-app 99.21%) preserved or improved coverage; QA evidence 08-qa/qa/final-hardening/HOP-HARD-APP-001-validation.md, security evidence 08-qa/security-quality/HOP-HARD-APP-001/security-quality-evidence.md, handoff 08-qa/handoffs/HOP-HARD-APP-001-summary.md)
