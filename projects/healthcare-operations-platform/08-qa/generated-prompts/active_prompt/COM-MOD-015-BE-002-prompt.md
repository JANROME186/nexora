# TASK: COM-MOD-015-BE-002 - Implement OCR, summary, search and retrieval custom rules
...
- Compilar outputs backend para el backlog activo: Implement OCR, summary, search and retrieval custom rules.
...
- Handoff previo: `08-qa/handoffs/COM-MOD-015-BE-001-summary.md`
...
- QA Evidence: `08-qa/qa/ai-overlay/COM-MOD-015-BE-002-validation.md`
- Security Evidence: `08-qa/security-quality/COM-MOD-015-BE-002/security-quality-evidence.md`
- Transición: crear `08-qa/handoffs/COM-MOD-015-BE-002-summary.md`.
...
- Commit: `feat(hop): compile AI overlay backend outputs`.
...
- El validador debe terminar con código 0, reportar `status: closed`, `Hard findings: 0` y generar evidencia en `08-qa/backlog-validations/COM-MOD-015-BE-002-closure-validation.md`.
- No modificar `backlog_validator.py` ni `tool-registry.md` para cerrar el backlog; son controles protegidos.
- Si el validador genera `COM-MOD-015-BE-002-closure-fix-prompt.md` o reporta inconsistencias, no declarar cierre; corregir solo producto/evidencia/registros y repetir commit + validación estricta.
...
<!-- ollama_plan_hash: 626d46714a62d0475e105e4e037eee1158c779db91784f62b58b525ebf84402c -->
