# TASK: HOP-HARD-IAM-001 - Authentication, authorization, session and entitlement runtime hardening
...
- Atender el slice de hardening activo: Authentication, authorization, session and entitlement runtime hardening.
...
- Handoff previo: `08-qa/handoffs/HOP-HARD-BE-001-summary.md`
...
- QA Evidence: `08-qa/qa/final-hardening/HOP-HARD-IAM-001-validation.md`
- Security Evidence: `08-qa/security-quality/HOP-HARD-IAM-001/security-quality-evidence.md`
- Transición: crear `08-qa/handoffs/HOP-HARD-IAM-001-summary.md`.
...
- Commit: `docs(hop): define final hardening debt burn-down`.
...
- El validador debe terminar con código 0, reportar `status: closed`, `Hard findings: 0` y generar evidencia en `08-qa/backlog-validations/HOP-HARD-IAM-001-closure-validation.md`.
- No modificar `backlog_validator.py` ni `tool-registry.md` para cerrar el backlog; son controles protegidos.
- Si el validador genera `HOP-HARD-IAM-001-closure-fix-prompt.md` o reporta inconsistencias, no declarar cierre; corregir solo producto/evidencia/registros y repetir commit + validación estricta.
...
<!-- ollama_plan_hash: 7dd4c8cccb800cc94f839bf63ea81c916f12fe5208eea1a9b1c4bfbb2a55e4df -->
