# TASK: COM-MOD-015-QA-001 - Safety, explainability and human-control evidence
...
- Atender el backlog activo: Safety, explainability and human-control evidence.
...
- Handoff previo: `08-qa/handoffs/COM-MOD-015-FE-001-summary.md`
...
- QA Evidence: `08-qa/qa/ai-overlay/COM-MOD-015-QA-001-validation.md`
- Security Evidence: `08-qa/security-quality/COM-MOD-015-QA-001/security-quality-evidence.md`
- Transición: crear `08-qa/handoffs/COM-MOD-015-QA-001-summary.md`.
...
- El validador debe terminar con código 0, reportar `status: closed`, `Hard findings: 0` y generar evidencia en `08-qa/backlog-validations/COM-MOD-015-QA-001-closure-validation.md`.
- No modificar `backlog_validator.py` ni `tool-registry.md` para cerrar el backlog; son controles protegidos.
- Si el validador genera `COM-MOD-015-QA-001-closure-fix-prompt.md` o reporta inconsistencias, no declarar cierre; corregir solo producto/evidencia/registros y repetir commit + validación estricta.
