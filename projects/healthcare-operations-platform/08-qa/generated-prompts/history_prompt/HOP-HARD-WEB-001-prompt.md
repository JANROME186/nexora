# TASK: HOP-HARD-WEB-001 - Public marketplace discovery surface and website hardening
...
- Atender el slice de hardening activo: Public marketplace discovery surface and website hardening.
...
- Handoff previo: `08-qa/handoffs/HOP-HARD-APP-001-summary.md`
...
- QA Evidence: `08-qa/qa/final-hardening/HOP-HARD-WEB-001-validation.md`
- Security Evidence: `08-qa/security-quality/HOP-HARD-WEB-001/security-quality-evidence.md`
- Transición: crear `08-qa/handoffs/HOP-HARD-WEB-001-summary.md`.
...
- El validador debe terminar con código 0, reportar `status: closed`, `Hard findings: 0` y generar evidencia en `08-qa/backlog-validations/HOP-HARD-WEB-001-closure-validation.md`.
- No modificar `backlog_validator.py` ni `tool-registry.md` para cerrar el backlog; son controles protegidos.
- Si el validador genera `HOP-HARD-WEB-001-closure-fix-prompt.md` o reporta inconsistencias, no declarar cierre; corregir solo producto/evidencia/registros y repetir commit + validación estricta.
...
<!-- ollama_plan_hash: 59472fffc9a1f84020c0597135c6511e343fd46fb48e52ea178566d06e5c3a57 -->
