# TASK: HOP-HARD-BE-001 - Backend quality, persistence and coverage debt burn-down
...
- Atender el slice de hardening activo: Backend quality, persistence and coverage debt burn-down.
...
- Handoff previo: `08-qa/handoffs/COM-MOD-015-CLOSEOUT-summary.md`
...
- QA Evidence: `08-qa/qa/final-hardening/HOP-HARD-BE-001-validation.md`
- Security Evidence: `08-qa/security-quality/HOP-HARD-BE-001/security-quality-evidence.md`
- Transición: crear `08-qa/handoffs/HOP-HARD-BE-001-summary.md`.
...
- Commit: `fix(hop): burn down backend hardening debt`.
...
- El validador debe terminar con código 0, reportar `status: closed`, `Hard findings: 0` y generar evidencia en `08-qa/backlog-validations/HOP-HARD-BE-001-closure-validation.md`.
- No modificar `backlog_validator.py` ni `tool-registry.md` para cerrar el backlog; son controles protegidos.
- Si el validador genera `HOP-HARD-BE-001-closure-fix-prompt.md` o reporta inconsistencias, no declarar cierre; corregir solo producto/evidencia/registros y repetir commit + validación estricta.
...
<!-- ollama_plan_hash: 01e0028773e10e8ccff3d2685c73dd5ecddfd3268dbadd0445f7fd1d4cb285e8 -->
