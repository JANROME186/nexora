# TASK: HOP-HARD-DATA-001 - Database, reference data, localization data and persistence hardening
...
- Atender el slice de hardening activo: Database, reference data, localization data and persistence hardening.
...
- Handoff previo: `08-qa/handoffs/HOP-HARD-IAM-001-summary.md`
...
- QA Evidence: `08-qa/qa/final-hardening/HOP-HARD-DATA-001-validation.md`
- Security Evidence: `08-qa/security-quality/HOP-HARD-DATA-001/security-quality-evidence.md`
- Transición: crear `08-qa/handoffs/HOP-HARD-DATA-001-summary.md`.
...
- El validador debe terminar con código 0, reportar `status: closed`, `Hard findings: 0` y generar evidencia en `08-qa/backlog-validations/HOP-HARD-DATA-001-closure-validation.md`.
- No modificar `backlog_validator.py` ni `tool-registry.md` para cerrar el backlog; son controles protegidos.
- Si el validador genera `HOP-HARD-DATA-001-closure-fix-prompt.md` o reporta inconsistencias, no declarar cierre; corregir solo producto/evidencia/registros y repetir commit + validación estricta.
