# TASK: COM-MOD-017-QA-001 - Integrated marketplace validation
...
- Atender el backlog activo: Integrated marketplace validation.
- Mantener ejecución agent-agnostic, sin dependencias propietarias de agentes o runtimes.
- Preservar o mejorar cobertura; objetivo final >= 80%.
...
- Handoff previo: `08-qa/handoffs/COM-MOD-017-FE-001-summary.md`
...
- QA Evidence: `08-qa/qa/product-marketplace-and-extension-packaging/COM-MOD-017-QA-001-validation.md`
- Security Evidence: `08-qa/security-quality/COM-MOD-017-QA-001/security-quality-evidence.md`
- Transición: crear `08-qa/handoffs/COM-MOD-017-QA-001-summary.md`.
...
- El validador debe terminar con código 0, reportar `status: closed`, `Hard findings: 0` y generar evidencia en `08-qa/backlog-validations/COM-MOD-017-QA-001-closure-validation.md`.
- Si el validador genera `COM-MOD-017-QA-001-closure-fix-prompt.md` o reporta inconsistencias, no declarar cierre; reportar los hallazgos, corregirlos y repetir commit + validación estricta.
- `git status --short` limpio después del commit y de la validación final.

<!-- ollama_plan_hash: bf5879634a8414d531fd00831350c18b2ce259c2ef4d0b0ae08ed46296bc88fb -->
