# TASK: HOP-HARD-INT-001 - Integration, OpenAPI generation, workflow, migration and observability hardening
...
- Atender el slice de hardening activo: Integration, OpenAPI generation, workflow, migration and observability hardening.
...
- Handoff previo: `08-qa/handoffs/HOP-HARD-WEB-001-summary.md`
...
- QA Evidence: `08-qa/qa/final-hardening/HOP-HARD-INT-001-validation.md`
- Security Evidence: `08-qa/security-quality/HOP-HARD-INT-001/security-quality-evidence.md`
- Transición: crear `08-qa/handoffs/HOP-HARD-INT-001-summary.md`.
...
- Commit: `fix(hop): burn down integration and platform hardening debt`.
...
- El validador debe terminar con código 0, reportar `status: closed`, `Hard findings: 0` y generar evidencia en `08-qa/backlog-validations/HOP-HARD-INT-001-closure-validation.md`.
- No modificar `backlog_validator.py` ni `tool-registry.md` para cerrar el backlog; son controles protegidos.
- Si el validador genera `HOP-HARD-INT-001-closure-fix-prompt.md` o reporta inconsistencias, no declarar cierre; corregir solo producto/evidencia/registros y repetir commit + validación estricta.
...
<!-- ollama_plan_hash: 5de169779daf1658d44b8d961c918ba31363e614ee3d9b7a036c105b32f4b9a4 -->
