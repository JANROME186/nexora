# TASK: HOP-HARD-APP-001 - Mobile, patient portal, doctor portal and imaging delivery hardening
...
- Atender el slice de hardening activo: Mobile, patient portal, doctor portal and imaging delivery hardening.
...
- Ejecutar gates app/mobile obligatorios: typecheck, tests/cobertura, build, SAST, dependencias, i18n y scans de seguridad.
...
- Handoff previo: `08-qa/handoffs/HOP-HARD-FE-001-summary.md`
...
## 4. Entregables
- Cambios mobile y validaciones asociadas.
- QA Evidence: `08-qa/qa/final-hardening/HOP-HARD-APP-001-validation.md`
- Security Evidence: `08-qa/security-quality/HOP-HARD-APP-001/security-quality-evidence.md`
- Transición: crear `08-qa/handoffs/HOP-HARD-APP-001-summary.md`.
...
- Commit: `fix(hop): burn down mobile and portal hardening debt`.
...
- El validador debe terminar con código 0, reportar `status: closed`, `Hard findings: 0` y generar evidencia en `08-qa/backlog-validations/HOP-HARD-APP-001-closure-validation.md`.
- No modificar `backlog_validator.py` ni `tool-registry.md` para cerrar el backlog; son controles protegidos.
- Si el validador genera `HOP-HARD-APP-001-closure-fix-prompt.md` o reporta inconsistencias, no declarar cierre; corregir solo producto/evidencia/registros y repetir commit + validación estricta.
