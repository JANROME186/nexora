# TASK: COM-MOD-015-BE-001 - Compile AI orchestration, policy and audit outputs
...
- Compilar outputs backend para el backlog activo: Compile AI orchestration, policy and audit outputs.
...
- Handoff previo: `08-qa/handoffs/COM-MOD-015-DEF-summary.md`
...
- QA Evidence: `08-qa/qa/ai-overlay/COM-MOD-015-BE-001-validation.md`
- Security Evidence: `08-qa/security-quality/COM-MOD-015-BE-001/security-quality-evidence.md`
- Transición: crear `08-qa/handoffs/COM-MOD-015-BE-001-summary.md`.
...
- El validador debe terminar con código 0, reportar `status: closed`, `Hard findings: 0` y generar evidencia en `08-qa/backlog-validations/COM-MOD-015-BE-001-closure-validation.md`.
- No modificar `backlog_validator.py` ni `tool-registry.md` para cerrar el backlog; son controles protegidos.
- Si el validador genera `COM-MOD-015-BE-001-closure-fix-prompt.md` o reporta inconsistencias, no declarar cierre; corregir solo producto/evidencia/registros y repetir commit + validación estricta.
...
<!-- ollama_plan_hash: 4bc8edd7fa3cd73d54c068cd3660b00bdd945a101b8a70efcc908025b56ecf55 -->
