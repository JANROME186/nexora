...
compatibilityevaluation, billingadapter capabilities), all 21 openapi-source.md operations functional
...
`generation-plan.md` (central entitlement policy evaluator, compatibility evaluation strategy,
...
entitlement-policy.md evaluation_order, the remaining compatibility.md dimensions, a more mature
