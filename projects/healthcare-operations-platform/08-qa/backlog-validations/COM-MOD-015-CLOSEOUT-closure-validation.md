...
Ollama summary: No hay riesgos o acciones disponibles para la tarea COM-MOD-015-CLOSEOUT.
...
context:
  ...
  hard_findings: []
ollama_review:
  summary: No hay riesgos o acciones disponibles para la tarea COM-MOD-015-CLOSEOUT.
  top_risks: []
  required_actions: []
```
