...
| Source | Related Artifacts |
|---|---|
| CAP-011 | Imaging Operations & DICOM/PACS Management |
| Business Rules | IMG-BR-001 through IMG-BR-020 |
...
| AI | Report summarization, template suggestions, worklist prioritization |
| QA | Contract, authorization, state, reconciliation, viewer access and audit tests |
