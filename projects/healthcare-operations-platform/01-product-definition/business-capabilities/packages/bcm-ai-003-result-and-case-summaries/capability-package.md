---
id: HOP-CAP-PKG-BCM-AI-003
format: markdown_structured_payload
type: capability-package
name: Result and Case Summaries Capability Package
version: 1.0.0
status: module_closed
---

# Result and Case Summaries Capability Package
...
capability:
  id: BCM-AI-003
  name:
    en: Result and Case Summaries
    es: Resumenes de Resultados y Casos
...
scope:
  summary: Defines attributable summaries for operational cases, result histories and imaging/lab review packets without replacing clinical validation.
  in_scope:
