...
capability:
  id: BCM-AI-002
  name:
    en: OCR Document Intake
    es: Ingreso Documental OCR
...
scope:
  summary: Models OCR extraction jobs for uploaded referrals, orders, invoices and external reports with confidence scoring and operator correction.
  in_scope:
