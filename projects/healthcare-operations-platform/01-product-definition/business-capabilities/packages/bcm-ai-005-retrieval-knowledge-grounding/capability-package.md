---
id: HOP-CAP-PKG-BCM-AI-005
format: markdown_structured_payload
type: capability-package
name: Retrieval Knowledge Grounding Capability Package
version: 1.0.0
status: modeled
---

# Retrieval Knowledge Grounding Capability Package
...
capability:
  id: BCM-AI-005
  name:
    en: Retrieval Knowledge Grounding
    es: Fundamentacion por Recuperacion de Conocimiento
...
scope:
  summary: Builds retrieval packages from approved HOP knowledge sources so generated answers include source citations and versioned evidence.
  in_scope:
