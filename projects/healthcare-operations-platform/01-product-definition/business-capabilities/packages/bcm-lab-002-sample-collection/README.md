...
| `business-model.yaml` | Sample aggregate, collection value objects and chain-of-custody |
| `business-rules.yaml` | Numbered rules RN-001..RN-009 |
| `processes.yaml` | Generate worklist, collect sample, reject at collection |
...
| `ui-model.yaml` | Employee portal worklist, collection form and sample detail |
| `mobile-model.yaml` | Mobile scope (sample_collection_later; intended future flows modeled) |
...
`traceability.yaml` documents that this package's SampleStatus model
