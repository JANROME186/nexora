---
id: HOP-CAP-PKG-BCM-AI-006
format: markdown_structured_payload
type: capability-package
name: Safety Policy and Human Review Capability Package
version: 1.0.0
status: module_closed
---

# Safety Policy and Human Review Capability Package
...
capability:
  id: BCM-AI-006
  name:
    en: Safety Policy and Human Review
    es: Politica de Seguridad y Revision Humana
...
scope:
  summary: Centralizes safety policy decisions, prohibited use enforcement, human review queues, override capture and escalation.
  in_scope:
