---
id: HOP-TRACE-BCM-INV-002
format: markdown_structured_payload
type: traceability
name: Reagent Management Traceability
version: 0.1.0
status: modeled
---

# Reagent Management Traceability
...
traces:
  ...
  domain_foundation:
    ...
    aggregate_reference: AGG-013 InventoryItem (owned by BCM-INV-001; reagentProfile
  ...
  - process: PRC-RGT-002-01
    commands:
    - AssignReagentProfile
  api_to_permissions:
  - operation: assignReagentProfile
    scope: inventory.reagent.manage
  - operation: getReagentProfile
    scope: inventory.reagent.read
  events_to_audit:
  - event: ReagentProfileAssigned
    audit_sink: BCM-PLT-007
  ui_to_api:
  - screen: SCR-RGT-002-01
    operations:
    - assignReagentProfile
    - getReagentProfile
  consumed_by_capabilities:
  - capability: BCM-INV-007
    relationship: Reads consumptionUnitRatio to automatically decrement stock on test
      performance.
  ...
  compilation_evidence:
    backend_implementation: ../../../../../07-implementation/backend/src/main/java/com/nexora/hop/platformfoundation/inventoryquality/reagentmanagement/
    ...
    notes: assignReagentProfile and getReagentProfile compiled. Delegated single-field
      mutation of InventoryItem.reagentProfile through InventoryItemService.save;
      itemType=reagent guard (RN-001), positive consumption ratio (RN-002) and discontinued-item
      guard (RN-004) implemented in ReagentManagementService.
  backlog_items:
