---
id: HOP-CAP-PKG-BCM-AI-007
format: markdown_structured_payload
type: capability-package
name: Model Provider Integration Capability Package
version: 1.0.0
status: module_closed
---

# Model Provider Integration Capability Package
...
capability:
  id: BCM-AI-007
  name:
    en: Model Provider Integration
    es: Integracion de Proveedor de Modelo
...
scope:
  summary: Defines replaceable provider profiles, routing policies, local/offline provider support, quota controls and adapter health without vendor lock-in.
  in_scope:
