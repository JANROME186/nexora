---
id: HOP-TRACE-BCM-PER-003
format: markdown_structured_payload
type: traceability
name: Doctor Management Traceability
version: 0.1.0
status: modeled
---

# Doctor Management Traceability
...
traces:
  ...
  brm_alignment:
  - rule: BRM-001-R003
    alignment: Related to Doctor aggregate isolation (medical-staff owning context)
      mirroring patient master data ownership pattern.
  - rule: BRM-001-R017
    alignment: AI cannot verify credentials or grant doctor access.
  - rule: BRM-001-R018
    alignment: Doctor events are append-only.
  rules_to_tests:
  - rule: RN-001
    tests:
    - TST-DOC-003-01
  ...
  - process: PRC-DOC-003-01
    commands:
    - RegisterDoctor
  - process: PRC-DOC-003-02
    commands:
    - AttachProfessionalCredential
    - VerifyProfessionalCredential
    - RevokeProfessionalCredential
  - process: PRC-DOC-003-03
    commands:
    - UpdateDoctor
    - AssignSpecialty
    - UnassignSpecialty
  - process: PRC-DOC-003-04
    commands:
    - SuspendDoctor
    - RetireDoctor
  - process: PRC-DOC-003-05
    commands:
    - PreparePortalAccess
  api_to_permissions:
  - operation: registerDoctor
    scope: doctor.write
  - operation: updateDoctor
    scope: doctor.write
  - operation: verifyDoctorCredential
    scope: doctor.credential.verify
  - operation: preparePortalAccess
    scope: doctor.portal.prepare
  - operation: suspendDoctor
    scope: doctor.write
  events_to_audit:
  ...
  compilation_backend_root: ../../../../07-implementation/backend/src/main/java/com/nexora/hop/platformfoundation/peopleclinicalmasterdata/doctormanagement/
