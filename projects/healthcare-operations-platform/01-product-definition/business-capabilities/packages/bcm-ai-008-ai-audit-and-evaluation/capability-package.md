---
id: HOP-CAP-PKG-BCM-AI-008
format: markdown_structured_payload
type: capability-package
name: AI Audit and Evaluation Capability Package
version: 1.0.0
status: module_closed
---

# AI Audit and Evaluation Capability Package
...
capability:
  id: BCM-AI-008
  name:
    en: AI Audit and Evaluation
    es: Auditoria y Evaluacion de IA
...
scope:
  summary: Tracks prompts, inputs, model metadata, evaluation sets, safety outcomes, drift indicators and audit-ready evidence for every AI-assisted workflow.
  in_scope:
