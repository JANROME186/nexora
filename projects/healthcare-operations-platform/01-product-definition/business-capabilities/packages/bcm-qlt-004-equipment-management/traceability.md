---
id: HOP-TRACE-BCM-QLT-004
format: markdown_structured_payload
type: traceability
name: Equipment Management Traceability
version: 0.1.0
status: modeled
---

# Equipment Management Traceability
...
traces:
  ...
  domain_foundation:
    ...
    aggregate_reference: AGG-013 InventoryItem (owned by BCM-INV-001; equipmentProfile
  ...
  - process: PRC-EQP-004-01
    commands:
    - SetEquipmentProfile
  - process: PRC-EQP-004-02
    commands:
    - ChangeEquipmentAvailability
  api_to_permissions:
  - operation: setEquipmentProfile
    scope: quality.equipment.manage
  - operation: changeEquipmentAvailability
    scope: quality.equipment.manage
  - operation: getEquipmentProfile
    scope: quality.equipment.read
  events_to_audit:
  ...
  - capability: BCM-LAB-006
    relationship: Reads equipment availability for laboratory processing assignment
      readiness.
