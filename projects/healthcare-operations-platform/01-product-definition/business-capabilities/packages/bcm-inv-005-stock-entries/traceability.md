---
id: HOP-TRACE-BCM-INV-005
format: markdown_structured_payload
type: traceability
name: Stock Entries Traceability
version: 0.1.0
status: modeled
---

# Stock Entries Traceability
...
traces:
  ...
  domain_foundation:
    ...
    aggregate_reference: AGG-013 InventoryItem (owned by BCM-INV-001; stockSummary
      increase delegated to this capability via ApplyStockReceipt)
  ...
  - process: PRC-SEN-005-01
    commands:
    - ApplyStockReceipt
  api_to_permissions:
  - operation: applyStockReceipt
    scope: inventory.entries.manage
  - operation: listStockEntries
    scope: inventory.entries.read
  events_to_audit:
  - event: StockReceived
    audit_sink: BCM-PLT-007
  ui_to_api:
  - screen: SCR-SEN-005-01
    operations:
    - applyStockReceipt
    - listStockEntries
  consumed_by_capabilities:
  - capability: BCM-INV-004
    relationship: Receives StockReceived to update purchase order line receivedQuantity
      rollup.
  - capability: BCM-INV-003
    relationship: Coordinates StockLot creation on first receipt of a new batch.
  ...
  compilation_evidence:
    backend_implementation: ../../../../../07-implementation/backend/src/main/java/com/nexora/hop/platformfoundation/inventoryquality/stockentries/
    ...
    notes: applyStockReceipt and listStockEntries compiled. Delegated Apply* increment
      of both InventoryItem.stockSummary.onHandQuantity and StockLot.remainingQuantity.
      Purchase-order- line receipts call back into ProcurementManagementService.recordLineReceipt
      so BCM-INV-004 remains authoritative for line/header state, then apply the stock
      delta locally.
  backlog_items:
