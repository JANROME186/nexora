...
info:
  ...
  version: 0.1.0
  description: Contract-first API for suppliers, inventory items, warehouses, stock
    movements, purchase orders, lots and inventory audits.
servers:
- url: /api/v1
security:
- bearerAuth: []
...
paths:
  ...
  /stock-balances:
    get:
      ...
      responses:
        '200':
          description: Stock balances
  /stock-movements:
    post:
      tags:
      - Stock
      summary: Post immutable stock movement
      parameters:
      ...
      requestBody:
        ...
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/PostStockMovementRequest'
      responses:
        '201':
  ...
  /inventory-audits:
    post:
      tags:
      - Audits
      summary: Start inventory audit
      requestBody:
        required: true
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/StartInventoryAuditRequest'
      responses:
        '201':
          description: Inventory audit started
components:
  securitySchemes:
    bearerAuth:
      type: http
    ...
    CreateSupplierRequest:
      ...
      properties:
        ...
        contacts:
          type: array
          items:
            $ref: '#/components/schemas/SupplierContactInput'
    ...
    CreatePurchaseRequest:
      ...
      properties:
        ...
        lines:
          type: array
          items:
            $ref: '#/components/schemas/PurchaseLineInput'
