---
artifact:
  id: HOP-COM-BACKLOG-ITEM-INDEX
  type: backlog-item-index
  status: active
  optimization: atomic_context
---

# HOP Backlog Item Index
...
- id: HOP-QA-ALIGN-001
  ...
  status: closed
  module_id: HOP-QUALITY-ALIGNMENT
  path: 06-delivery/commercial-product/backlog-map/items/HOP-QA-ALIGN-001.md
- id: HOP-QA-ALIGN-002
  name: Implement backend Java/Maven enterprise quality profile
  status: closed_with_residual_p1_debt
  module_id: HOP-QUALITY-ALIGNMENT
  path: 06-delivery/commercial-product/backlog-map/items/HOP-QA-ALIGN-002.md
- id: HOP-QA-ALIGN-003
  name: Implement frontend web enterprise quality profile
  status: closed_with_residual_p1_debt
  module_id: HOP-QUALITY-ALIGNMENT
  path: 06-delivery/commercial-product/backlog-map/items/HOP-QA-ALIGN-003.md
- id: HOP-QA-ALIGN-004
  name: Establish all-severity vulnerability, DAST and runtime security evidence
  status: closed
  module_id: HOP-QUALITY-ALIGNMENT
  path: 06-delivery/commercial-product/backlog-map/items/HOP-QA-ALIGN-004.md
- id: HOP-QA-ALIGN-005
  name: Establish message externalization and magic-string remediation baseline
  status: closed
  module_id: HOP-QUALITY-ALIGNMENT
  path: 06-delivery/commercial-product/backlog-map/items/HOP-QA-ALIGN-005.md
- id: HOP-QA-ALIGN-006
  name: Update integrated local runbook with quality gate execution
  status: closed
  module_id: HOP-QUALITY-ALIGNMENT
  path: 06-delivery/commercial-product/backlog-map/items/HOP-QA-ALIGN-006.md
- id: HOP-QA-ALIGN-CLOSEOUT
  name: Close HOP enterprise quality alignment and resume MVP-MOD-004-FE-001
  status: closed
  module_id: HOP-QUALITY-ALIGNMENT
  path: 06-delivery/commercial-product/backlog-map/items/HOP-QA-ALIGN-CLOSEOUT.md
- id: HOP-ENT-FOUND-001
  name: Align HOP enterprise product foundations before continuing portals
  status: closed
  module_id: HOP-ENTERPRISE-FOUNDATION-ALIGNMENT
...
- id: MVP-MOD-005-DEF
  name: Capability package models
  status: closed
  module_id: MVP-MOD-005
  path: 06-delivery/commercial-product/backlog-map/items/MVP-MOD-005-DEF.md
- id: MVP-MOD-005-BE-001
  name: Compile cash session, payment and sale backend outputs
  status: closed
  module_id: MVP-MOD-005
  path: 06-delivery/commercial-product/backlog-map/items/MVP-MOD-005-BE-001.md
- id: MVP-MOD-005-BE-002
  name: Implement billing request adapter custom boundary
  status: closed
  module_id: MVP-MOD-005
  path: 06-delivery/commercial-product/backlog-map/items/MVP-MOD-005-BE-002.md
- id: MVP-MOD-005-FE-001
  name: Compile cashier and billing request UI outputs
  status: closed
  module_id: MVP-MOD-005
  path: 06-delivery/commercial-product/backlog-map/items/MVP-MOD-005-FE-001.md
- id: MVP-MOD-005-QA-001
  name: Financial audit and reconciliation evidence
  status: closed
  module_id: MVP-MOD-005
  path: 06-delivery/commercial-product/backlog-map/items/MVP-MOD-005-QA-001.md
- id: MVP-MOD-005-CLOSEOUT
  name: Module closeout and registry update
  status: closed
  module_id: MVP-MOD-005
  path: 06-delivery/commercial-product/backlog-map/items/MVP-MOD-005-CLOSEOUT.md
- id: MVP-MOD-006-DEF
  name: Capability package models
  status: closed
  module_id: MVP-MOD-006
  path: 06-delivery/commercial-product/backlog-map/items/MVP-MOD-006-DEF.md
- id: MVP-MOD-006-BE-001
  name: Compile sample lifecycle backend outputs
  status: closed
  module_id: MVP-MOD-006
  path: 06-delivery/commercial-product/backlog-map/items/MVP-MOD-006-BE-001.md
- id: MVP-MOD-006-BE-002
  name: Implement result capture and validation custom rules
  status: closed
  module_id: MVP-MOD-006
  path: 06-delivery/commercial-product/backlog-map/items/MVP-MOD-006-BE-002.md
- id: MVP-MOD-006-FE-001
  name: Compile sample, processing and validation UI outputs
  status: closed
  module_id: MVP-MOD-006
  path: 06-delivery/commercial-product/backlog-map/items/MVP-MOD-006-FE-001.md
- id: MVP-MOD-006-QA-001
  name: Lab workflow and clinical control evidence
  status: closed
  module_id: MVP-MOD-006
  path: 06-delivery/commercial-product/backlog-map/items/MVP-MOD-006-QA-001.md
- id: MVP-MOD-006-CLOSEOUT
  name: Module closeout and registry update
  status: closed
  module_id: MVP-MOD-006
  path: 06-delivery/commercial-product/backlog-map/items/MVP-MOD-006-CLOSEOUT.md
- id: MVP-MOD-007-DEF
  name: Capability package models
  status: closed
  module_id: MVP-MOD-007
  path: 06-delivery/commercial-product/backlog-map/items/MVP-MOD-007-DEF.md
- id: MVP-MOD-007-BE-001
  name: Compile result report and document generation outputs
  status: closed
  module_id: MVP-MOD-007
  path: 06-delivery/commercial-product/backlog-map/items/MVP-MOD-007-BE-001.md
- id: MVP-MOD-007-BE-002
  name: Implement digital delivery, notification and critical result custom rules
  status: closed
  module_id: MVP-MOD-007
  path: 06-delivery/commercial-product/backlog-map/items/MVP-MOD-007-BE-002.md
- id: MVP-MOD-007-FE-001
  name: Compile employee result delivery UI outputs
  status: closed
  module_id: MVP-MOD-007
  path: 06-delivery/commercial-product/backlog-map/items/MVP-MOD-007-FE-001.md
- id: MVP-MOD-007-PORTAL-001
  name: Compile patient and doctor released result views
  status: closed
  module_id: MVP-MOD-007
  path: 06-delivery/commercial-product/backlog-map/items/MVP-MOD-007-PORTAL-001.md
- id: MVP-MOD-007-APP-001
  name: Compile mobile result view and notification baseline
  status: closed
  module_id: MVP-MOD-007
  path: 06-delivery/commercial-product/backlog-map/items/MVP-MOD-007-APP-001.md
- id: MVP-MOD-007-QA-001
  name: Result access, PDF and notification evidence
  status: closed
  module_id: MVP-MOD-007
  path: 06-delivery/commercial-product/backlog-map/items/MVP-MOD-007-QA-001.md
- id: MVP-MOD-007-CLOSEOUT
  name: Module closeout and registry update
  status: closed
  module_id: MVP-MOD-007
  path: 06-delivery/commercial-product/backlog-map/items/MVP-MOD-007-CLOSEOUT.md
- id: MVP-MOD-008-DEF
  name: Capability package models
  status: closed
  module_id: MVP-MOD-008
  path: 06-delivery/commercial-product/backlog-map/items/MVP-MOD-008-DEF.md
- id: MVP-MOD-008-BE-001
  name: Compile integration adapter contracts and API governance outputs
  status: closed
  module_id: MVP-MOD-008
  path: 06-delivery/commercial-product/backlog-map/items/MVP-MOD-008-BE-001.md
- id: MVP-MOD-008-BE-002
  ...
  status: closed
  module_id: MVP-MOD-008
  path: 06-delivery/commercial-product/backlog-map/items/MVP-MOD-008-BE-002.md
- id: MVP-MOD-008-FE-001
  name: Compile integration and migration administration UI outputs
  status: closed
  module_id: MVP-MOD-008
  path: 06-delivery/commercial-product/backlog-map/items/MVP-MOD-008-FE-001.md
- id: MVP-MOD-008-QA-001
  name: Adapter, import and observability evidence
  status: closed
  module_id: MVP-MOD-008
  path: 06-delivery/commercial-product/backlog-map/items/MVP-MOD-008-QA-001.md
- id: MVP-MOD-008-CLOSEOUT
  name: Operational Core closeout
  status: closed
  module_id: MVP-MOD-008
  path: 06-delivery/commercial-product/backlog-map/items/MVP-MOD-008-CLOSEOUT.md
- id: COM-MOD-009-DEF
  name: Capability package models
  status: closed
  module_id: COM-MOD-009
  path: 06-delivery/commercial-product/backlog-map/items/COM-MOD-009-DEF.md
- id: COM-MOD-009-BE-001
  name: Compile portal access and authorization outputs
  status: closed
  module_id: COM-MOD-009
  path: 06-delivery/commercial-product/backlog-map/items/COM-MOD-009-BE-001.md
- id: COM-MOD-009-PORTAL-001
  name: Compile patient portal commercial workflow
  status: closed
  module_id: COM-MOD-009
  path: 06-delivery/commercial-product/backlog-map/items/COM-MOD-009-PORTAL-001.md
- id: COM-MOD-009-PORTAL-002
  name: Compile doctor portal commercial workflow
  status: closed
  module_id: COM-MOD-009
  path: 06-delivery/commercial-product/backlog-map/items/COM-MOD-009-PORTAL-002.md
- id: COM-MOD-009-APP-001
  name: Patient mobile workflow
  status: closed
  module_id: COM-MOD-009
  path: 06-delivery/commercial-product/backlog-map/items/COM-MOD-009-APP-001.md
- id: COM-MOD-009-QA-001
  name: Channel access and privacy evidence
  status: closed
  module_id: COM-MOD-009
  path: 06-delivery/commercial-product/backlog-map/items/COM-MOD-009-QA-001.md
- id: COM-MOD-009-CLOSEOUT
  name: Module closeout and registry update
  status: closed
  module_id: COM-MOD-009
  path: 06-delivery/commercial-product/backlog-map/items/COM-MOD-009-CLOSEOUT.md
- id: COM-MOD-010-DEF
  name: Capability package models
  status: closed
  module_id: COM-MOD-010
  path: 06-delivery/commercial-product/backlog-map/items/COM-MOD-010-DEF.md
- id: COM-MOD-010-BE-001
  name: Compile product, reagent, lot and stock outputs
  status: closed
  module_id: COM-MOD-010
  path: 06-delivery/commercial-product/backlog-map/items/COM-MOD-010-BE-001.md
- id: COM-MOD-010-BE-002
  name: Compile equipment, maintenance and internal QC outputs
  status: closed
  module_id: COM-MOD-010
  path: 06-delivery/commercial-product/backlog-map/items/COM-MOD-010-BE-002.md
- id: COM-MOD-010-FE-001
  name: Compile inventory and internal quality UI outputs
  status: closed
  module_id: COM-MOD-010
  path: 06-delivery/commercial-product/backlog-map/items/COM-MOD-010-FE-001.md
- id: COM-MOD-010-QA-001
  name: Traceability, stock and quality evidence
  status: closed
  module_id: COM-MOD-010
  path: 06-delivery/commercial-product/backlog-map/items/COM-MOD-010-QA-001.md
- id: COM-MOD-010-CLOSEOUT
  name: Module closeout and registry update
  status: closed
  module_id: COM-MOD-010
  path: 06-delivery/commercial-product/backlog-map/items/COM-MOD-010-CLOSEOUT.md
- id: COM-MOD-011-DEF
  name: Capability package models
  status: closed
  module_id: COM-MOD-011
  path: 06-delivery/commercial-product/backlog-map/items/COM-MOD-011-DEF.md
- id: COM-MOD-011-BE-001
  name: Compile public catalog, location and request outputs
  status: closed
  module_id: COM-MOD-011
  path: 06-delivery/commercial-product/backlog-map/items/COM-MOD-011-BE-001.md
- id: COM-MOD-011-WEB-001
  name: Compile public website service discovery and conversion flows
  status: closed
  module_id: COM-MOD-011
  path: 06-delivery/commercial-product/backlog-map/items/COM-MOD-011-WEB-001.md
- id: COM-MOD-011-FE-001
  name: Content and request administration screens
  status: closed
  module_id: COM-MOD-011
  path: 06-delivery/commercial-product/backlog-map/items/COM-MOD-011-FE-001.md
- id: COM-MOD-011-QA-001
  name: Public web, SEO and privacy evidence
  status: closed
  module_id: COM-MOD-011
  path: 06-delivery/commercial-product/backlog-map/items/COM-MOD-011-QA-001.md
- id: COM-MOD-011-CLOSEOUT
  name: Module closeout and registry update
  status: closed
  module_id: COM-MOD-011
  path: 06-delivery/commercial-product/backlog-map/items/COM-MOD-011-CLOSEOUT.md
- id: COM-MOD-012-DEF
  name: Capability package models
  status: closed
  module_id: COM-MOD-012
  path: 06-delivery/commercial-product/backlog-map/items/COM-MOD-012-DEF.md
- id: COM-MOD-012-OPS-001
  name: Production deployment and environment strategy
  status: closed
  module_id: COM-MOD-012
  path: 06-delivery/commercial-product/backlog-map/items/COM-MOD-012-OPS-001.md
- id: COM-MOD-012-OPS-002
  name: Observability, backup, restore and incident runbooks
  status: closed
  module_id: COM-MOD-012
  path: 06-delivery/commercial-product/backlog-map/items/COM-MOD-012-OPS-002.md
- id: COM-MOD-012-BE-001
  name: Compile tenant operations, feature flags and operational controls
  status: closed
  module_id: COM-MOD-012
  path: 06-delivery/commercial-product/backlog-map/items/COM-MOD-012-BE-001.md
- id: COM-MOD-012-QA-001
  name: Performance, resilience and security evidence
  status: closed
  module_id: COM-MOD-012
  path: 06-delivery/commercial-product/backlog-map/items/COM-MOD-012-QA-001.md
- id: COM-MOD-012-CLOSEOUT
  name: Module closeout and registry update
  status: closed
  module_id: COM-MOD-012
  path: 06-delivery/commercial-product/backlog-map/items/COM-MOD-012-CLOSEOUT.md
- id: COM-MOD-013-DEF
  name: Capability package models
  status: closed
  module_id: COM-MOD-013
  path: 06-delivery/commercial-product/backlog-map/items/COM-MOD-013-DEF.md
- id: COM-MOD-013-BE-001
  name: Compile external QC, CAPA and audit management outputs
  status: closed
  module_id: COM-MOD-013
  path: 06-delivery/commercial-product/backlog-map/items/COM-MOD-013-BE-001.md
- id: COM-MOD-013-FE-001
  name: Compile quality and compliance UI outputs
  status: closed
  module_id: COM-MOD-013
  path: 06-delivery/commercial-product/backlog-map/items/COM-MOD-013-FE-001.md
- id: COM-MOD-013-QA-001
  name: Compliance workflow and evidence retention validation
  status: closed
  module_id: COM-MOD-013
  path: 06-delivery/commercial-product/backlog-map/items/COM-MOD-013-QA-001.md
- id: COM-MOD-013-CLOSEOUT
  name: Module closeout and registry update
  status: closed
  module_id: COM-MOD-013
  path: 06-delivery/commercial-product/backlog-map/items/COM-MOD-013-CLOSEOUT.md
- id: COM-MOD-014-DEF
  name: Capability package models
  status: closed
  module_id: COM-MOD-014
  path: 06-delivery/commercial-product/backlog-map/items/COM-MOD-014-DEF.md
- id: COM-MOD-014-BE-001
  name: Compile imaging workflow outputs
  status: closed
  module_id: COM-MOD-014
  path: 06-delivery/commercial-product/backlog-map/items/COM-MOD-014-BE-001.md
- id: COM-MOD-014-INT-001
  name: Implement DICOM and PACS adapter custom boundaries
  status: closed
  module_id: COM-MOD-014
  path: 06-delivery/commercial-product/backlog-map/items/COM-MOD-014-INT-001.md
...
- id: COM-MOD-015-BE-001
  ...
  status: closed
  module_id: COM-MOD-015
  path: 06-delivery/commercial-product/backlog-map/items/COM-MOD-015-BE-001.md
- id: COM-MOD-015-BE-002
  name: Implement OCR, summary, search and retrieval custom rules
  status: closed
  module_id: COM-MOD-015
  path: 06-delivery/commercial-product/backlog-map/items/COM-MOD-015-BE-002.md
...
- id: COM-MOD-016-DEF
  name: Capability package models
  status: closed
  module_id: COM-MOD-016
  path: 06-delivery/commercial-product/backlog-map/items/COM-MOD-016-DEF.md
- id: COM-MOD-016-DOC-001
  name: Customer onboarding and configuration guides
  status: closed
  module_id: COM-MOD-016
  path: 06-delivery/commercial-product/backlog-map/items/COM-MOD-016-DOC-001.md
- id: COM-MOD-016-OPS-001
  name: Support, escalation and release governance
  status: closed
  module_id: COM-MOD-016
  path: 06-delivery/commercial-product/backlog-map/items/COM-MOD-016-OPS-001.md
- id: COM-MOD-016-COM-001
  name: Pricing package, sales demo and launch readiness assets
  status: closed
  module_id: COM-MOD-016
  path: 06-delivery/commercial-product/backlog-map/items/COM-MOD-016-COM-001.md
- id: COM-MOD-016-QA-001
  name: Commercial readiness validation
  status: closed
  module_id: COM-MOD-016
  path: 06-delivery/commercial-product/backlog-map/items/COM-MOD-016-QA-001.md
- id: COM-MOD-016-CLOSEOUT
  name: General availability closeout
  status: closed
  module_id: COM-MOD-016
  path: 06-delivery/commercial-product/backlog-map/items/COM-MOD-016-CLOSEOUT.md
- id: COM-MOD-017-DEF
  name: Marketplace capability package and commercial package models
  status: closed
  module_id: COM-MOD-017
  path: 06-delivery/commercial-product/backlog-map/items/COM-MOD-017-DEF.md
- id: COM-MOD-017-BE-001
  name: Compile marketplace catalog, offer, entitlement and installation backend outputs
  status: closed
  module_id: COM-MOD-017
  path: 06-delivery/commercial-product/backlog-map/items/COM-MOD-017-BE-001.md
- id: COM-MOD-017-BE-002
  name: Implement custom entitlement enforcement and billing provider adapter boundary
  status: closed
  module_id: COM-MOD-017
  path: 06-delivery/commercial-product/backlog-map/items/COM-MOD-017-BE-002.md
- id: NXF-FMT-002
  name: Framework and HOP frontmatter optimization before functional backlog resumes
  status: closed
  module_id: COM-MOD-017
  path: 06-delivery/commercial-product/backlog-map/items/NXF-FMT-002.md
- id: COM-MOD-017-FE-001
  name: Compile marketplace administration and package installation UI outputs
  status: closed
  module_id: COM-MOD-017
  path: 06-delivery/commercial-product/backlog-map/items/COM-MOD-017-FE-001.md
- id: COM-MOD-017-WEB-001
  ...
  module_id: COM-MOD-017
  path: 06-delivery/commercial-product/backlog-map/items/COM-MOD-017-WEB-001.md
- id: COM-MOD-017-QA-001
  name: Validate purchase, entitlement, installation, activation, upgrade, rollback and retirement evidence
  status: closed
  module_id: COM-MOD-017
  path: 06-delivery/commercial-product/backlog-map/items/COM-MOD-017-QA-001.md
- id: COM-MOD-017-CLOSEOUT
  name: Marketplace readiness closeout and registry update
  status: closed
  module_id: COM-MOD-017
  path: 06-delivery/commercial-product/backlog-map/items/COM-MOD-017-CLOSEOUT.md
- id: HOP-HARD-BE-001
