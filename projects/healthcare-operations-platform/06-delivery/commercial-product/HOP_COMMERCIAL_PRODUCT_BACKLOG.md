...
product:
  ...
  current_baseline:
    ...
    active_module_progress: HOP-HARD-WEB-001 closed. Final hardening now advances to integration, OpenAPI generation, workflow, migration and observability hardening.
