...
HOP has advanced through `MVP-MOD-004-QA-001` and `HOP-QUALITY-ALIGNMENT` (`HOP-QA-ALIGN-001`
...
`HOP-QA-ALIGN-CLOSEOUT` passed and `MVP-MOD-004-QA-001` is closed. Continue with `MVP-MOD-004-CLOSEOUT` from:
