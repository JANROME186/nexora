...
HOP has advanced through `MVP-MOD-005-DEF` and `HOP-QUALITY-ALIGNMENT` (`HOP-QA-ALIGN-001`
...
`HOP-QA-ALIGN-CLOSEOUT` passed and `MVP-MOD-005-DEF` is closed. Continue with `MVP-MOD-005-BE-001` from:
