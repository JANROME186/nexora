...
HOP has advanced through `MVP-MOD-004-CLOSEOUT` and `HOP-QUALITY-ALIGNMENT` (`HOP-QA-ALIGN-001`
...
`HOP-QA-ALIGN-CLOSEOUT` passed and `MVP-MOD-004-CLOSEOUT` is closed. Continue with `MVP-MOD-005-DEF` from:
