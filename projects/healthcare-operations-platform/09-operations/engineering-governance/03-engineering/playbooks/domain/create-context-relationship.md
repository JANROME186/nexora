# Playbook — Create Context Relationship

## Steps

1. Identify source bounded context.
2. Identify target bounded context.
3. Confirm aggregate ownership.
4. Select DDD relationship type.
